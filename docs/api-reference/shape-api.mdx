...
| GET | `/api/shape/dip/namespaces/system/provision/regions` | GET avaialable Regions for Application Traffic Insights. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/top/type/malicious/dimension/ip/&#123;attack_type&#125;` | Top Souce IP of Attack Intent. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/top/type/malicious/dimension/ip/&#123;attack_type&#125;` | Top Souce IP of Attack Intent V2. |
