---
title: "\U0001F510 واجهة برمجة التطبيقات Api"
description: تعريفات الواجهة، والتحقق من المخططات، والتجميع.
sidebar:
  hidden: true
i18n:
...
فهرسة الموارد مع التصنيف التلقائي وتحديد ملفات الأمان. تقوم التسلسلات الهرمية التنظيمية بتقسيم الوصول حسب الوظيفة أو سياسة الحماية.
...
- تعريف مجموعات واجهات برمجة التطبيقات وسياسات الاختبار

## الموارد الأساسية

- **api_definition**: تعريف مخطط واجهة برمجة التطبيقات للاكتشاف والحماية
- **api_endpoint**: تكوين وحماية نقطة نهاية فردية لواجهة برمجة التطبيقات
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/api_definitions/&#123;name&#125;/loadbalancers` | الحصول على موازنات الحمل المرجعية. |
