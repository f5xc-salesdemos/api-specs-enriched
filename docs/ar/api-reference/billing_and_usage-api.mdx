...
انتقالات الخطط والفواتير واستهلاك الموارد. حدود الحصص على مستوى مساحة الأسماء وتتبع الاستخدام.
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/usage/invoices/custom_list` | سرد الفواتير. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/quotas` | سرد الحصص. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/quotas/&#123;name&#125;` | الحصول على الحصة. |
| DELETE | `/api/web/namespaces/&#123;namespace&#125;/quotas/&#123;name&#125;` | حذف الحصة. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/subscriptions/custom_list` | سرد الاشتراكات. |
...
| POST | `/api/web/namespaces/&#123;namespace&#125;/current_usage` | سرد تفاصيل الاستخدام الحالي. |
| POST | `/api/web/namespaces/&#123;namespace&#125;/hourly_usage_details` | سرد تفاصيل الاستخدام بالساعة. |
| POST | `/api/web/namespaces/&#123;namespace&#125;/monthly_usage` | سرد تفاصيل الاستخدام الشهري. |
| POST | `/api/web/namespaces/&#123;namespace&#125;/usage_details` | سرد تفاصيل الاستخدام. |
| GET | `/api/web/namespaces/system/usage_plans/current` | الحصول على خطة الاستخدام الحالية. |
| GET | `/api/web/namespaces/system/usage_plans/custom_list` | سرد خطط الاستخدام. |

## الروابط

- [مرجع واجهة برمجة التطبيقات التفاعلي](./billing_and_usage/)
- [ملف JSON لمواصفات OpenAPI](../specifications/api/billing_and_usage.json)
