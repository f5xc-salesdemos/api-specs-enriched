...
التوفير المستند إلى الرموز المميزة مع تنزيلات الصور والتحقق قبل الترقية. يتيح تجميع الأساطيل تنفيذ العمليات المجمعة عبر المواقع الموزعة.
...
| POST | `/api/register/namespaces/system/get-registrations-by-token` | الحصول على معرف التسجيل بواسطة رمز الموقع. |
...
| POST | `/api/register/registerBootstrap` | إنشاء التسجيل. |
