...
- إدارة عمليات نشر مواقع XCKS (Kubernetes المُدار) (المعروفة سابقاً بـ AppStack)
...
| POST | `/api/web/namespaces/system/revoke/global-kubeconfigs` | إلغاء تكوين Kubeconfig العام. |
...
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/pods` | قائمة الحاويات |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/secrets` | قائمة الأسرار. |
...
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/pods` | قائمة الحاويات |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/secrets` | قائمة الأسرار. |
...
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/deployments` | قائمة عمليات النشر. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/daemonsets` | قائمة DaemonSet. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/deployments` | قائمة عمليات النشر. |
...
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1/jobs` | قائمة المهام |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1/namespaces/&#123;namespace&#125;/jobs` | قائمة المهام |
...
| POST | `/api/data/namespaces/system/topology/dc_cluster_group/&#123;dc_cluster_group&#125;` | طوبولوجيا مجموعة مركز البيانات. |
| GET | `/api/data/namespaces/system/topology/dc_cluster_groups` | ملخص مجموعات مركز البيانات. |
