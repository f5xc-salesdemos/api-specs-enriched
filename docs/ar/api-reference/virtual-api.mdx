...
- تكوين المضيفات الافتراضية والتوجيه
- تعريف سياسات محدد المعدل والخدمة
- إدارة التوجيه المستند إلى الموقع الجغرافي
- تكوين سياسات الوكيل والتوجيه
- إدارة الحماية من البرامج الضارة وحملات التهديد
...
- **healthcheck**: تكوين مراقبة الصحة لتوفر خوادم الأصل
...
| POST | `/api/data/namespaces/system/app_security/all_ns_search/loadbalancers` | البحث في موازنات الأحمال لجميع مساحات الأسماء. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/search/loadbalancers` | البحث في موازنات الأحمال. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/ddos_mitigation/suggestion` | اقتراح قاعدة التخفيف من DDoS. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/l7ddos_rps_threshold` | تعيين عتبة RPS لـ L7 DDoS. |
...
| POST | `/api/config/namespaces/system/malware_protection/addon/subscribe` | الاشتراك في الحماية من البرامج الضارة. |
| POST | `/api/config/namespaces/system/malware_protection/addon/unsubscribe` | إلغاء الاشتراك في الحماية من البرامج الضارة. |
| POST | `/api/config/dns/namespaces/&#123;metadata.namespace&#125;/geo_location_sets` | إنشاء الموقع الجغرافي. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/healthchecks` | قائمة فحص الصحة. |
...
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/origin_pools` | إنشاء مجموعة الأصل. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/proxies/&#123;metadata.name&#125;` | استبدال وكيل. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/proxies` | قائمة الوكيل. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/proxies/&#123;name&#125;` | الحصول على وكيل |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/proxies/&#123;name&#125;` | حذف وكيل. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/proxies/&#123;name&#125;/ca_certificate` | الحصول على شهادة CA لخادم الوكيل. |
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/rate_limiter_policys` | إنشاء المواصفة. |
...
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoint/pdf` | الحصول على PDF نقطة نهاية API. |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoint/unmerge_sources_openapi_schema` | إلغاء دمج المصدر من نقطة نهاية API. |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/summary/top_active` | الحصول على أعلى نقاط نهاية API للمضيف الافتراضي. |
