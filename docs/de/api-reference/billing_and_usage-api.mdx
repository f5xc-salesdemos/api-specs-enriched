...
- Ressourcenkontingentnutzung über Namespaces hinweg verfolgen
...
|---------|------|--------------|
| POST | `/api/data/namespaces/system/billing/usage_summary` | Abrechnungsübersicht. |
...
| DELETE | `/api/web/namespaces/&#123;namespace&#125;/billing/payment_methods/&#123;name&#125;` | Die angegebene Zahlungsmethode LÖSCHEN. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/quota/limits` | Benutzerdefiniertes GET Kontingentlimits. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/quota/usage` | GET Kontingentnutzung. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/quotas` | Kontingente auflisten. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/quotas/&#123;name&#125;` | GET Kontingent |
...
| GET | `/api/web/namespaces/system/usage_plans/current` | GET aktuellen Nutzungsplan. |
