---
title: "\U0001F4B3 Abrechnung und Nutzung API"
...
Planübergänge, Rechnungsstellung und Ressourcenverbrauch. Kontingentlimits und Nutzungsverfolgung auf Namespace-Ebene.
...
- Abonnementpläne und Abrechnungsübergänge verwalten
- Zahlungsmethoden und Rechnungen konfigurieren
- Ressourcenkontingent-Nutzung über Namespaces hinweg verfolgen
- Nutzungslimits und Kapazitäten überwachen

## Primäre Ressourcen

- **subscription**: Abonnement für Dienstleistungsansprüche
...
|---------|------|--------------|
| POST | `/api/data/namespaces/system/billing/usage_summary` | Abrechnungs-Nutzungsübersicht. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/usage/invoice_pdf` | Rechnungs-PDF abrufen. |
...
| POST | `/api/web/namespaces/&#123;namespace&#125;/billing/payment_methods` | Zahlungsmethoden-Spezifikation erstellen. |
| DELETE | `/api/web/namespaces/&#123;namespace&#125;/billing/payment_methods/&#123;name&#125;` | Angegebene Zahlungsmethode LÖSCHEN. |
| GET | `/no_auth/namespaces/system/billing/plan_transition` | Planübergang abrufen. |
| POST | `/api/web/namespaces/&#123;namespace&#125;/billing/plan_transition` | Planübergang einleiten. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/quota/limits` | Benutzerdefinierte Kontingentlimits abrufen. |
...
| POST | `/api/web/namespaces/system/addon/subscribe` | XC-Zusatzdienste abonnieren. |
| POST | `/api/web/namespaces/system/addon/unsubscribe` | XC-Zusatzdienste abbestellen. |
