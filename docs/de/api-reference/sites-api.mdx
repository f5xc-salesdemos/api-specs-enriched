...
Integration von AWS, Azure und GCP VPC mit Transit Gateways. Label-basierte Auswahl für Richtlinienanwendung über Regionen hinweg.
...
- Bereitstellung von Secure Mesh Sites für netzwerkfokussierte Edge-Deployments
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites` | AWS TGW Sites auflisten. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites/&#123;name&#125;` | AWS TGW Site abrufen. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites/&#123;name&#125;` | AWS TGW Site löschen. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites` | AWS VPC Sites auflisten. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites/&#123;name&#125;` | AWS VPC Site abrufen. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites/&#123;name&#125;` | AWS VPC Site löschen. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites` | App Stack Sites auflisten. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites/&#123;name&#125;` | App Stack Site abrufen. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites/&#123;name&#125;` | App Stack Site löschen. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites` | Azure VNet Sites auflisten. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites/&#123;name&#125;` | Azure VNet Site abrufen. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites/&#123;name&#125;` | Azure VNet Site löschen. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites` | GCP VPC Sites auflisten. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites/&#123;name&#125;` | GCP VPC Site abrufen. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites/&#123;name&#125;` | GCP VPC Site löschen. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites` | Secure Mesh Sites auflisten. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites/&#123;name&#125;` | Secure Mesh Site abrufen. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites/&#123;name&#125;` | Secure Mesh Site löschen. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s` | Secure Mesh Sites auflisten. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s/&#123;name&#125;` | Secure Mesh Site abrufen. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s/&#123;name&#125;` | Secure Mesh Site löschen. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/site/&#123;site&#125;/external_connector/&#123;external_connector&#125;/logs` | Externer-Connector-Log-Abfrage. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/upgrade_os` | OS aktualisieren. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/upgrade_sw` | SW aktualisieren. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites` | Virtuelle Sites auflisten. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites/&#123;name&#125;/selectees` | Ausgewählte Elemente abrufen. |
