...
AWS-, Azure-, GCP-VPC-Integration mit Transit Gateways. Label-basierte Auswahl für Richtlinienanwendung über Regionen hinweg.
...
- F5 XC über Cloud-Anbieter (AWS, Azure, GCP) bereitstellen
- XCKS (Managed Kubernetes) Site-Bereitstellungen verwalten (ehemals AppStack)
- Secure Mesh Sites für netzwerkfokussierte Edge-Bereitstellungen deployen
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/platform_events` | Plattform-Ereignisabfrage. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites` | Virtual Sites auflisten. |
