...
8. [Tool-Integrationsleitfaden](#tool-integrationsleitfaden)

---

## Überblick

Die Erweiterung `x-f5xc-constraints` stellt deterministisches Wissen über Feldvalidierungs-Constraints bereit und ermöglicht:

- **KI-Assistenten**: Generierung gültiger Konfigurationen ohne Benutzereingabe für Constraint-Details
- **CLI-Tools**: Bereitstellung akkurater Eingabehinweise, Validierung und Fehlermeldungen
- **Terraform**: Durchsetzung von Constraints zur Plan-Zeit, nicht zur Apply-Zeit
...
- **95% Konfidenz** bei hochpriorisierten Feldern (Namen, Ports, Identifikatoren)
- **3-stufige Abgleichung**: EXISTING > DISCOVERY > INFERRED
...
| *(Constraint-Schlüssel)* | verschieden | Typspezifische Constraint-Schlüssel auf oberster Ebene abgeflacht (z.B. `minLength`, `maxItems`, `minimum`) |
...
- Bindestriche sind erlaubt, jedoch nicht am Anfang/Ende (RFC 1123)
...
**Timeouts**:
- Timeouts müssen 1-3600 Sekunden betragen (maximal 1 Stunde)
...
|---------|----------------|------------|
| 0,90-1,00 | **Hohe Konfidenz** | Deterministisches Flag aktiviert, Verwendung für KI-Generierung |
...
- Das Muster gut etablierten Standards entspricht (RFC, ISO usw.)
...
Constraints werden mittels 3-stufiger Priorität abgeglichen:
...
### Hochkonfidente Muster (0,95-0,99)
...
### Mittelkonfidente Muster (0,80-0,94)
...
- **Issues**: Melden Sie Probleme mit der Constraint-Genauigkeit unter https://github.com/f5xc-salesdemos/api-specs-enriched/issues
- **Dokumentation**: Vollständige API-Dokumentation unter https://f5xc-salesdemos.github.io/api-specs-enriched/
- **MCP-Integration**: Siehe das Repository `f5xc-api-mcp` für Beispiele zur MCP-Server-Integration
