...
description: 'Servicios adicionales, conectores y políticas TPM.'
sidebar:
  hidden: true
i18n:
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/addon_services` | Listar servicio adicional. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/addon_services/&#123;name&#125;` | Obtener servicio adicional. |
| POST | `/api/web/namespaces/&#123;metadata.namespace&#125;/addon_subscriptions` | Crear suscripción adicional. |
| PUT | `/api/web/namespaces/&#123;metadata.namespace&#125;/addon_subscriptions/&#123;metadata.name&#125;` | Reemplazar suscripción adicional. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/addon_subscriptions` | Listar suscripción adicional. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/addon_subscriptions/&#123;name&#125;` | Obtener suscripción adicional. |
| DELETE | `/api/web/namespaces/&#123;namespace&#125;/addon_subscriptions/&#123;name&#125;` | Eliminar suscripción adicional. |
...
| POST | `/no_auth/namespaces/system/aws/f5xc-saas/signup` | Registrarse en cuenta de AWS. |
...
- [Referencia de API interactiva](./marketplace/)
