...
Aprovisionamiento de túneles GRE e IPSec de terceros con temporizadores DPD. Asignación de recursos compartidos entre namespaces con controles de ubicación de mosaicos.
...
| POST | `/no_auth/namespaces/system/aws/f5xc-saas/signup` | Registro de cuenta de AWS. |
...
| POST | `/no_auth/namespaces/system/f5xc-saas/signup` | Registro en XC SaaS. |
