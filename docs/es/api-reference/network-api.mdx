...
Protocolo de puerta de enlace de frontera con gestión de ASN y relaciones de sistemas autónomos. VPN sitio a sitio enlazando centros de datos a través de canales cifrados.
...
- Definir conexiones de segmentos y políticas
- Configurar conjuntos de prefijos IP

## Recursos Principales

- **virtual_network**: Red virtual para conectividad de sitios y segmentación
...
| GET | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/bgp_peers` | Mostrar Info de Pares BGP. |
