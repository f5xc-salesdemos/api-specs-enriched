---
title: "\U0001F30D API de Sitios"
description: Despliegues en la nube y nodos edge.
sidebar:
  hidden: true
i18n:
...
Integración de VPC de AWS, Azure y GCP con transit gateways. Selección basada en etiquetas para la aplicación de políticas entre regiones.
...
- Desplegar F5 XC en múltiples proveedores de nube (AWS, Azure, GCP)
- Gestionar despliegues de sitios XCKS (Managed Kubernetes) (anteriormente AppStack)
- Desplegar sitios Secure Mesh para despliegues edge enfocados en redes
- Integrar clústeres Kubernetes externos como Customer Edge
- Configurar sitios AWS VPC, Azure VNet y GCP VPC
- Gestionar sitios virtuales y políticas de sitios

## Recursos Principales

- **site**: Ubicación de despliegue física o en la nube para servicios edge
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites` | Listar configuración de sitio AWS TGW. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites/&#123;name&#125;` | Obtener sitio AWS TGW. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites/&#123;name&#125;` | Eliminar configuración de sitio AWS TGW. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites` | Listar configuración de sitio AWS VPC. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites/&#123;name&#125;` | Obtener sitio AWS VPC. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites/&#123;name&#125;` | Eliminar configuración de sitio AWS VPC. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites` | Listar configuración de sitio App Stack. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites/&#123;name&#125;` | Obtener sitio App Stack. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites/&#123;name&#125;` | Eliminar configuración de sitio App Stack. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites` | Listar configuración de sitio Azure VNet. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites/&#123;name&#125;` | Obtener sitio Azure VNet. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites/&#123;name&#125;` | Eliminar configuración de sitio Azure VNet. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites` | Listar configuración de sitio GCP VPC. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites/&#123;name&#125;` | Obtener sitio GCP VPC. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites/&#123;name&#125;` | Eliminar configuración de sitio GCP VPC. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites` | Listar configuración de sitio Secure Mesh. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites/&#123;name&#125;` | Obtener sitio Secure Mesh. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites/&#123;name&#125;` | Eliminar configuración de sitio Secure Mesh. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s` | Listar configuración de sitio Secure Mesh. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s/&#123;name&#125;` | Obtener sitio Secure Mesh. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s/&#123;name&#125;` | Eliminar configuración de sitio Secure Mesh. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/site/&#123;site&#125;/external_connector/&#123;external_connector&#125;/logs` | Consulta de registros de conector externo. |
...
| POST | `/api/data/namespaces/system/site/&#123;name&#125;/status` | Verificar existencia de sitio. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site` | Consulta de grafo del sitio. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/edge` | Consulta de arista del sitio. |
...
| GET | `/api/data/namespaces/system/topology/site_mesh_groups` | Resumen de grupos Site Mesh. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites/&#123;name&#125;/selectees` | Obtener elementos seleccionados. |

## Enlaces

- [Referencia interactiva de la API](./sites/)
- [Especificación OpenAPI en JSON](../specifications/api/sites.json)
