...
description: Despliegues en la nube y en nodos edge.
sidebar:
  hidden: true
i18n:
...
Integración de VPC con AWS, Azure y GCP mediante transit gateways. Selección basada en etiquetas para la aplicación de políticas entre regiones.
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_site/&#123;name&#125;/set_vip_info` | Configurar información de VIP del sitio AWS TGW. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites` | Listar sitios AWS TGW configurados. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites/&#123;name&#125;` | Obtener sitio AWS TGW. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites/&#123;name&#125;` | Eliminar sitio AWS TGW configurado. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_site/&#123;name&#125;/set_vip_info` | Configurar información de VIP del sitio AWS VPC. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites` | Listar sitios AWS VPC configurados. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites/&#123;name&#125;` | Obtener sitio AWS VPC. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites/&#123;name&#125;` | Eliminar sitio AWS VPC configurado. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites` | Listar sitios App Stack configurados. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites/&#123;name&#125;` | Obtener sitio App Stack. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites/&#123;name&#125;` | Eliminar sitio App Stack configurado. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_site/&#123;name&#125;/set_vip_info` | Configurar información de VIP del sitio Azure VNet. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_site/&#123;name&#125;/validate_config` | Validar configuración del sitio Azure VNet. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites` | Listar sitios Azure VNet configurados. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites/&#123;name&#125;` | Obtener sitio Azure VNet. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites/&#123;name&#125;` | Eliminar sitio Azure VNet configurado. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites` | Listar sitios GCP VPC configurados. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites/&#123;name&#125;` | Obtener sitio GCP VPC. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites/&#123;name&#125;` | Eliminar sitio GCP VPC configurado. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites` | Listar sitios Secure Mesh configurados. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites/&#123;name&#125;` | Obtener sitio Secure Mesh. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites/&#123;name&#125;` | Eliminar sitio Secure Mesh configurado. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s` | Listar sitios Secure Mesh configurados. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s/&#123;name&#125;` | Obtener sitio Secure Mesh. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s/&#123;name&#125;` | Eliminar sitio Secure Mesh configurado. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/k8s_clusters` | Listar clústeres K8s. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites` | Listar sitios |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites` | Listar sitios virtuales. |
