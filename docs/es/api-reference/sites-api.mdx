...
Integración de AWS, Azure, GCP VPC con transit gateways. Selección basada en etiquetas para la aplicación de políticas entre regiones.
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites/&#123;name&#125;/selectees` | Obtener seleccionados. |

## Enlaces

- [Referencia interactiva de la API](./sites/)
- [JSON de especificación OpenAPI](../specifications/api/sites.json)
