...
- Definir limitadores de tasa y políticas de servicio
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/api_endpoint_protection/suggestion` | Sugerir regla de protección de endpoint API. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/rate_limit/suggestion` | Sugerir regla de límite de tasa. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/rate_limiter_policys` | Listar Política de Limitador de Tasa. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/rate_limiter_policys/&#123;name&#125;` | Obtener Especificación. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/rate_limiter_policys/&#123;name&#125;` | Eliminar Política de Limitador de Tasa. |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/summary/top_active` | Obtener Principales Endpoints de API para Host Virtual. |
...
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/swagger_spec` | Obtener Swagger Spec para Tipo de Aplicación. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/client/rule_hits` | Métricas de Impactos de Reglas del Cliente. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/client/security_events` | Métricas de Eventos de Seguridad del Cliente. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/server/rule_hits` | Métricas de Impactos de Reglas del Servidor. |
