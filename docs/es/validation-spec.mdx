...
La especificación de validación consolida las restricciones de validación de API, valores predeterminados y metadatos de configuración en un único archivo JSON. Esta especificación se genera a partir de las especificaciones OpenAPI enriquecidas y se publica junto con ellas.
...
Define los valores permitidos para campos restringidos.
...
| `recommended` | Valores prellenados en la consola web de F5 XC | Análisis de la interfaz de usuario |
...
| Corrección de errores o actualización de descripciones | Parche | Correcciones tipográficas |
