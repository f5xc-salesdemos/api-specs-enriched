...
|----------|-------------|--------|
| `server_applied` | Valores que la API aplica cuando se omiten campos | Pruebas con la API en vivo |
| `recommended` | Valores pre-completados en la consola web de F5 XC | Análisis de la interfaz de usuario |
| `advanced_options` | Valores predeterminados anidados dentro de objetos advanced_options | Descubrimiento de la API |
...
2. **Descubrimiento** - Restricciones del descubrimiento de la API en vivo
3. **Inferido** - Restricciones de la coincidencia de patrones (prioridad más baja)
...
|---------|------|---------|
| 2.1.2 | 2026-01-18 | Reescrito como referencia pura de API; se añadieron las categorías oneof_recommended y nested_recommended |
| 2.1.0 | 2026-01-18 | Estructura de valores predeterminados unificada reemplazando secciones fragmentadas |
