...
| GET | `/api/config/namespaces/&#123;namespace&#125;/cdn_loadbalancers/&#123;name&#125;/dos_automitigation_rules` | Obtenir les règles d'auto-atténuation DoS pour l'équilibreur de charge CDN. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/cdn_loadbalancers/&#123;name&#125;/dos_automitigation_rules/&#123;dos_automitigation_rule_name&#125;` | Supprimer une règle d'auto-atténuation DoS pour l'équilibreur de charge CDN. |
...
| POST | `/api/cdn/namespaces/&#123;namespace&#125;/http_loadbalancer/&#123;name&#125;/cache-purge` | Purger le cache de l'équilibreur de charge. |
