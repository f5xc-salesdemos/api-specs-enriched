...
- Déployer des espaces de noms XCCS (Services de Conteneurs) pour les charges de travail multi-tenant
...
- **pod_security_policy** : Politique de sécurité des pods pour les contraintes du runtime de conteneurs
