...
Protocole de passerelle de bordure avec gestion ASN et relations de systèmes autonomes. VPN site à site reliant les centres de données via des canaux chiffrés.
...
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/bgps` | Créer BGP. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/bgps/&#123;metadata.name&#125;` | Remplacer BGP. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/bgps` | Lister BGP |
| GET | `/api/config/namespaces/&#123;namespace&#125;/bgps/&#123;name&#125;` | Obtenir BGP |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/bgps/&#123;name&#125;` | Supprimer BGP. |
