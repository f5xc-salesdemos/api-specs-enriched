...
Règles de pare-feu avec décisions de routage basées sur la source, la destination ou le protocole. La segmentation isole les charges de travail tandis que les proxys sortants régissent les accès.

- **Catégorie** : Sécurité
- **Complexité** : avancée
- **Chemins** : 62 | **Schémas** : 386
- **Niveau** : Avancé
- **Domaines connexes** : `virtual`, `api`, `network`
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/forward_proxy_policy/hits` | Hits de politique de proxy direct. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/forward_proxy_policys` | Lister les configurations de politique de proxy direct. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/forward_proxy_policys/&#123;name&#125;` | Obtenir une politique de proxy direct. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/forward_proxy_policys/&#123;name&#125;` | Supprimer la configuration de politique de proxy direct. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/network_policy_view/hits` | Hits de politique réseau. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/network_policy_views` | Lister les configurations de vue de politique réseau. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/network_policy_views/&#123;name&#125;` | Obtenir une vue de politique réseau. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/network_policy_views/&#123;name&#125;` | Supprimer la configuration de vue de politique réseau. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/fast_acl/hits` | Hits d'ACL rapide. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/filter_sets/find` | Trouver des ensembles de filtres pour une ou plusieurs clés de contexte. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/network_policy/hits` | Hits de politique réseau. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/service_policy/hits` | Hits de politique de service. |
