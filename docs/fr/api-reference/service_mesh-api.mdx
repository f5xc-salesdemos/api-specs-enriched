...
- Gérer la découverte et le routage des points de terminaison
...
- **origin_pool** : Groupe de serveurs backend pour la distribution du trafic par le répartiteur de charge
- **service_discovery** : Configuration de découverte de services pour les points de terminaison dynamiques
