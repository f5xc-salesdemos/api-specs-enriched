...
description: Déploiements cloud et nœuds périphériques.
sidebar:
  hidden: true
i18n:
...
Intégration AWS, Azure, GCP VPC avec les passerelles de transit. Sélection basée sur les labels pour l'application des politiques à travers les régions.
...
- Déployer des sites Secure Mesh pour les déploiements périphériques orientés réseau
...
- **site** : Emplacement de déploiement physique ou cloud pour les services périphériques
...
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/configmaps` | Liste des ConfigMaps. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/endpoints` | Liste des Endpoints. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces` | Liste des Namespaces. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/configmaps` | Liste des ConfigMaps. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/endpoints` | Liste des Endpoints. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/persistentvolumeclaims` | Liste des PersistentVolumeClaims. |
...
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/nodes` | Liste des Namespaces. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/persistentvolumeclaims` | Liste des PersistentVolumeClaims. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/persistentvolumes` | Liste des PersistentVolumes. |
...
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/daemonsets` | Liste des DaemonSets. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/deployments` | Liste des Deployments. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/daemonsets` | Liste des DaemonSets. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/deployments` | Liste des Deployments. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/replicasets` | Liste des ReplicaSets. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/statefulsets` | Liste des StatefulSets. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/replicasets` | Liste des ReplicaSets. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/statefulsets` | Liste des StatefulSets. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1/jobs` | Liste des Jobs |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1/namespaces/&#123;namespace&#125;/jobs` | Liste des Jobs |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1beta1/cronjobs` | Liste des CronJobs. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1beta1/namespaces/&#123;namespace&#125;/cronjobs` | Liste des CronJobs. |
| POST | `/api/data/namespaces/system/site/&#123;site&#125;/namespaces/&#123;namespace&#125;/pods/metrics` | Métriques des Pods. |
| POST | `/api/data/namespaces/system/site/&#123;site&#125;/namespaces/&#123;namespace&#125;/virtualmachineinstances/metrics` | Métriques des instances de machines virtuelles. |
| POST | `/api/data/namespaces/system/site/&#123;site&#125;/pods/metrics` | Métriques des Pods. |
| POST | `/api/data/namespaces/system/site/&#123;site&#125;/virtualmachineinstances/metrics` | Métriques des instances de machines virtuelles. |
| GET | `/api/web/namespaces/system/sites/&#123;site&#125;/global-kubeconfigs` | Lister les Kube Configs globales. |
| POST | `/api/web/namespaces/system/sites/&#123;site&#125;/global-kubeconfigs` | Créer une Kube Config globale. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/local-kubeconfig` | Créer une Kube Config locale pour le cluster K8s. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/local-kubeconfigs` | Lister les Kube Configs locales. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site` | Requête du graphe de site. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/edge` | Requête des arêtes du site. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/node` | Requête des nœuds du site. |
