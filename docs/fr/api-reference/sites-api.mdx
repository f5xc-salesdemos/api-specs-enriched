...
description: Déploiements cloud et nœuds de périphérie.
sidebar:
  hidden: true
i18n:
...
Intégration AWS, Azure, GCP VPC avec des passerelles de transit. Sélection basée sur les labels pour l'application de politiques à travers les régions.
...
- Déployer F5 XC sur les fournisseurs cloud (AWS, Azure, GCP)
- Gérer les déploiements de sites XCKS (Kubernetes managé) (anciennement AppStack)
- Déployer des sites Secure Mesh pour les déploiements de périphérie orientés réseau
...
- **site** : Emplacement de déploiement physique ou cloud pour les services de périphérie
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites` | Lister la configuration des sites AWS TGW. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_site/&#123;name&#125;/storage/set_vpc_k8s_hostnames` | Configurer les noms d'hôte K8s du VPC. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_site/&#123;name&#125;/validate_config` | Valider la configuration du site AWS VPC. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites` | Lister la configuration des sites AWS VPC. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites` | Lister la configuration des sites App Stack. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites` | Lister la configuration des sites Azure VNet. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites` | Lister la configuration des sites GCP VPC. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites` | Lister la configuration des sites Secure Mesh. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s` | Lister la configuration des sites Secure Mesh. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site` | Requête de graphe du site. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/edge` | Requête d'arête du site. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/node` | Requête de nœud du site. |
