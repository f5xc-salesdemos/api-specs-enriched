...
इमेज डाउनलोड और प्री-अपग्रेड सत्यापन के साथ टोकन-आधारित प्रोविज़निंग। फ्लीट ग्रुपिंग वितरित स्थानों पर बल्क ऑपरेशन सक्षम करती है।
...
| POST | `/api/register/namespaces/system/suggest-values` | मान सुझाव। |
