...
- प्री-अपग्रेड चेक के साथ साइट अपग्रेड निष्पादित करें
...
| POST | `/api/register/namespaces/&#123;namespace&#125;/listregistrationsbystate` | स्थिति द्वारा पंजीकरण सूची। |
...
| GET | `/api/register/namespaces/&#123;namespace&#125;/registrations_by_site/&#123;site_name&#125;` | साइट द्वारा पंजीकरण सूची। |
