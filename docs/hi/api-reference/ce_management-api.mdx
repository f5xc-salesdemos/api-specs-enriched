...
description: 'नेटवर्क इंटरफेस, फ्लीट्स, और साइट पंजीकरण।'
sidebar:
  hidden: true
i18n:
...
इमेज डाउनलोड और प्री-अपग्रेड सत्यापन के साथ टोकन-आधारित प्रोविजनिंग। फ्लीट ग्रुपिंग वितरित स्थानों पर बल्क ऑपरेशन सक्षम करती है।
...
- Customer Edge साइट जीवनचक्र प्रबंधन
