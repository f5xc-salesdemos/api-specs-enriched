...
सभी डिफ़ॉल्ट मान एक एकीकृत संरचना में संसाधन प्रकार के अनुसार व्यवस्थित।
...
| श्रेणी | विवरण | स्रोत |
|----------|-------------|--------|
| `server_applied` | वे मान जो फ़ील्ड छोड़ने पर API लागू करता है | लाइव API परीक्षण |
| `recommended` | F5 XC वेब कंसोल द्वारा पूर्व-भरे मान | UI विश्लेषण |
| `advanced_options` | advanced_options ऑब्जेक्ट्स के भीतर नेस्टेड डिफ़ॉल्ट | API खोज |
| `oneof_choices` | डिफ़ॉल्ट OneOf वेरिएंट चयन | API व्यवहार |
| `oneof_recommended` | अनुशंसित OneOf वेरिएंट | कंसोल डिफ़ॉल्ट |
...
|-----------|---------|----------|
| `x-f5xc-required-for` | संदर्भ-विशिष्ट आवश्यक फ़ील्ड | स्कीमा प्रॉपर्टीज़ |
| `x-f5xc-server-default` | सर्वर-लागू डिफ़ॉल्ट को चिह्नित करता है | स्कीमा प्रॉपर्टीज़ |
| `x-f5xc-recommended-value` | अनुशंसित डिफ़ॉल्ट मान | स्कीमा प्रॉपर्टीज़ |
| `x-f5xc-recommended-oneof-variant` | अनुशंसित OneOf वेरिएंट | स्कीमा परिभाषाएँ |
| `x-f5xc-conditions` | सशर्त आवश्यकताएँ | स्कीमा प्रॉपर्टीज़ |
| `x-f5xc-minimum-configuration` | न्यूनतम कॉन्फ़िग उदाहरण | स्कीमा परिभाषाएँ |
| `x-f5xc-validation` | खोज-व्युत्पन्न बाधाएँ | स्कीमा प्रॉपर्टीज़ |
...
|-------------|--------------|---------|
| ब्रेकिंग संरचना परिवर्तन | मेजर | फ़ील्ड नाम बदलना, अनुभाग हटाना |
| नए सत्यापन नियम या संसाधन | माइनर | नए संसाधन डिफ़ॉल्ट |
| बग फ़िक्स या विवरण अपडेट | पैच | टाइपो सुधार |

## समाधान प्राथमिकता

जब कई स्रोत बाधाएँ प्रदान करते हैं, तो समाधान प्राथमिकता इस प्रकार है:

1. **मौजूदा** - मूल OpenAPI स्पेक में बाधाएँ (सर्वोच्च प्राथमिकता)
2. **खोज** - लाइव API खोज से बाधाएँ
3. **अनुमानित** - पैटर्न मिलान से बाधाएँ (न्यूनतम प्राथमिकता)
...
| 2.1.0 | 2026-01-18 | खंडित अनुभागों को प्रतिस्थापित करती एकीकृत डिफ़ॉल्ट संरचना |
