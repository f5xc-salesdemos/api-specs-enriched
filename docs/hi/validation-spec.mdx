...
सत्यापन विनिर्देश API सत्यापन बाधाओं, डिफ़ॉल्ट मानों और कॉन्फ़िगरेशन मेटाडेटा को एक एकल JSON फ़ाइल में समेकित करता है। यह विनिर्देश समृद्ध OpenAPI specs से उत्पन्न होता है और उनके साथ प्रकाशित किया जाता है।
...
प्रत्येक संसाधन के लिए ऑपरेशन प्रकार के अनुसार आवश्यक फ़ील्ड निर्दिष्ट करता है।
...
प्रतिबंधित फ़ील्ड के लिए अनुमत मानों को परिभाषित करता है।
...
| श्रेणी | विवरण | स्रोत |
|----------|-------------|--------|
| `server_applied` | वे मान जो API फ़ील्ड छोड़े जाने पर लागू करता है | लाइव API परीक्षण |
...
| `ui_vs_server` | वे मामले जहाँ UI डिफ़ॉल्ट API डिफ़ॉल्ट से भिन्न हैं | तुलनात्मक विश्लेषण |
...
समृद्ध OpenAPI specs इन एक्सटेंशन का उपयोग करके सत्यापन मेटाडेटा एम्बेड करते हैं:

| एक्सटेंशन | उद्देश्य | स्थान |
|-----------|---------|----------|
| `x-f5xc-required-for` | संदर्भ-विशिष्ट आवश्यक फ़ील्ड | स्कीमा प्रॉपर्टी |
| `x-f5xc-server-default` | सर्वर-लागू डिफ़ॉल्ट को चिह्नित करता है | स्कीमा प्रॉपर्टी |
| `x-f5xc-recommended-value` | अनुशंसित डिफ़ॉल्ट मान | स्कीमा प्रॉपर्टी |
| `x-f5xc-recommended-oneof-variant` | अनुशंसित OneOf वेरिएंट | स्कीमा परिभाषाएँ |
| `x-f5xc-conditions` | सशर्त आवश्यकताएँ | स्कीमा प्रॉपर्टी |
| `x-f5xc-minimum-configuration` | न्यूनतम कॉन्फ़िग उदाहरण | स्कीमा परिभाषाएँ |
| `x-f5xc-validation` | खोज-व्युत्पन्न बाधाएँ | स्कीमा प्रॉपर्टी |
...
सत्यापन spec `version` फ़ील्ड में सिमेंटिक वर्शनिंग का पालन करता है:

| परिवर्तन प्रकार | वर्शन बदलाव | उदाहरण |
|-------------|--------------|---------|
| संरचना में तोड़-फोड़ परिवर्तन | मेजर | फ़ील्ड का नाम बदलना, अनुभाग हटाना |
...
1. **मौजूदा** - मूल OpenAPI spec में बाधाएँ (सर्वोच्च प्राथमिकता)
2. **खोज** - लाइव API खोज से बाधाएँ
3. **अनुमानित** - पैटर्न मिलान से बाधाएँ (न्यूनतम प्राथमिकता)

## संबंधित दस्तावेज़ीकरण

- [Healthcheck Enhancements](./Enhancements/healthcheck-enhancements/) - हेल्थचेक स्कीमा संवर्धन
- [Origin Pool Enhancements](./Enhancements/originpool-enhancements/) - ऑरिजिन पूल स्कीमा संवर्धन
- [CLAUDE.md](../../CLAUDE.md) - AI सहायक निर्देश
- [DEVELOPMENT.md](./development/) - डेवलपर गाइड

## परिवर्तन लॉग

| वर्शन | तारीख | परिवर्तन |
|---------|------|---------|
| 2.1.2 | 2026-01-18 | शुद्ध API संदर्भ के रूप में पुनर्लिखित; oneof_recommended और nested_recommended श्रेणियाँ जोड़ी गईं |
| 2.1.0 | 2026-01-18 | खंडित अनुभागों की जगह एकीकृत defaults संरचना |
