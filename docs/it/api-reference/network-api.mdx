...
Protocollo border gateway con gestione ASN e relazioni tra sistemi autonomi. VPN site-to-site che collega datacenter attraverso canali crittografati.
...
- Configurare connettori di rete e rotte
- Gestire SRv6 e subnetting
- Definire connessioni di segmento e policy
- Configurare set di prefissi IP

## Risorse principali

- **virtual_network**: Rete virtuale per la connettività e segmentazione dei siti
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/bgpstatus/&#123;view_name&#125;` | GET Stato BGP per vista. |
...
| GET | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/bgp_peers` | Mostra informazioni BGP Peer. |
| GET | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/bgp_routes` | Mostra rotte BGP. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ike1s/&#123;name&#125;` | GET configurazione profilo IKE Phase1. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/ike1s/&#123;name&#125;` | DELETE profilo IKE Phase 1. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ike_phase1_profiles/&#123;name&#125;` | GET configurazione profilo IKE Phase1. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/ike_phase1_profiles/&#123;name&#125;` | DELETE profilo IKE Phase 1. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ike2s/&#123;name&#125;` | GET configurazione profilo IKE Phase2. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/ike2s/&#123;name&#125;` | DELETE profilo IKE Phase 2. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ike_phase2_profiles/&#123;name&#125;` | GET configurazione profilo IKE Phase2. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/ike_phase2_profiles/&#123;name&#125;` | DELETE profilo IKE Phase 2. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/public_ips/&#123;metadata.name&#125;` | Sostituisci Public IP. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/public_ips` | Elenca Public IP. |
...
| POST | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/routes` | Mostra rotte. |
| POST | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/simplified_routes` | Mostra rotte semplificate. |
