...
- **virtual_network**: Rete virtuale per connettività e segmentazione dei siti
- **network_connector**: Connettore di rete per connettività site-to-site o cloud
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/public_ips` | Elenca IP Pubblico. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/public_ips/&#123;name&#125;` | Ottieni IP Pubblico. |
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/routes` | Crea Rotta. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/routes/&#123;metadata.name&#125;` | Sostituisci Rotta. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/routes` | Elenca Rotta. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/routes/&#123;name&#125;` | Ottieni Rotta |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/routes/&#123;name&#125;` | Elimina Rotta. |
