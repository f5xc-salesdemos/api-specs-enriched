...
- Gestire il discovery degli endpoint e il routing
...
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/app_types/&#123;app_type_name&#125;/api_endpoints/swagger_spec` | GET Swagger Spec per App Type. |
...
| POST | `/api/config/namespaces/system/nfv_service/&#123;name&#125;/force-delete` | Force DELETE Servizio NFV. |
...
| POST | `/api/maurice/software_os_version` | GET OS basato su SW_VERSION. |
