...
Integrazione VPC di AWS, Azure e GCP con transit gateway. Selezione basata su etichette per l'applicazione delle policy tra le regioni.
...
- Distribuire siti Secure Mesh per distribuzioni edge incentrate sulla rete
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/edge` | Query archi del sito. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/node` | Query nodi del sito. |
...
| GET | `/api/data/namespaces/system/topology/site_mesh_groups` | Riepilogo gruppi mesh del sito. |
