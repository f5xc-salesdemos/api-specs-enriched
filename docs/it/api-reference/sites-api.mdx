...
description: Distribuzioni cloud e nodi edge.
sidebar:
  hidden: true
i18n:
...
Integrazione AWS, Azure, GCP VPC con transit gateway. Selezione basata su etichette per l'applicazione delle policy tra regioni.
...
- Distribuire F5 XC tra provider cloud (AWS, Azure, GCP)
- Gestire distribuzioni di siti XCKS (Managed Kubernetes) (precedentemente AppStack)
- Distribuire siti Secure Mesh per distribuzioni edge focalizzate sulla rete
...
- **site**: Posizione di distribuzione fisica o cloud per servizi edge
- **virtual_site**: Raggruppamento logico di siti tramite selettori di etichette
- **site_mesh_group**: Configurazione di connettività mesh tra più siti
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites/&#123;name&#125;` | Ottieni sito AWS TGW. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites/&#123;name&#125;` | Elimina configurazione sito AWS TGW. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites/&#123;name&#125;` | Ottieni sito AWS VPC. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites/&#123;name&#125;` | Elimina configurazione sito AWS VPC. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites/&#123;name&#125;` | Ottieni sito App Stack. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites/&#123;name&#125;` | Elimina configurazione sito App Stack. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites/&#123;name&#125;` | Ottieni sito Azure VNet. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites/&#123;name&#125;` | Elimina configurazione sito Azure VNet. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites/&#123;name&#125;` | Ottieni sito GCP VPC. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites/&#123;name&#125;` | Elimina configurazione sito GCP VPC. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites/&#123;name&#125;` | Ottieni sito Secure Mesh. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites/&#123;name&#125;` | Elimina configurazione sito Secure Mesh. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s/&#123;name&#125;` | Ottieni sito Secure Mesh. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s/&#123;name&#125;` | Elimina configurazione sito Secure Mesh. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/k8s_clusters/&#123;name&#125;` | Ottieni specifica di configurazione. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/k8s_clusters/&#123;name&#125;` | Elimina cluster K8s. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/site/&#123;site&#125;/k8s_audit_logs` | Query log audit K8s. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/site/&#123;site&#125;/k8s_audit_logs/aggregation` | Query di aggregazione log audit K8s. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/vk8s_audit_logs/aggregation` | Query di aggregazione log audit VK8s. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites` | Elenca siti |
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;` | Ottieni sito |
| POST | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/local-kubeconfig` | Crea configurazione Kube locale del cluster K8s. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/local-kubeconfigs` | Elenca configurazioni Kube locali. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/upgrade_os` | Aggiorna SO. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site` | Query grafo del sito. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/edge` | Query arco del sito. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/graph/site/node` | Query nodo del sito. |
...
| GET | `/api/data/namespaces/system/topology/network/&#123;id&#125;/route_tables` | Ottieni tabelle di routing della rete. |
| GET | `/api/data/namespaces/system/topology/route_table/&#123;name&#125;` | Ottieni tabella di routing. |
| GET | `/api/data/namespaces/system/topology/site/&#123;name&#125;/networks` | Ottieni reti del sito. |
| POST | `/api/data/namespaces/system/topology/site/&#123;site&#125;` | Topologia del sito. |
| POST | `/api/data/namespaces/system/topology/site_mesh_group/&#123;site_mesh_group&#125;` | Topologia mesh del sito. |
| GET | `/api/data/namespaces/system/topology/site_mesh_groups` | Riepilogo gruppi mesh dei siti. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_k8ss/&#123;name&#125;` | Ottieni Kubernetes virtuale. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/virtual_k8ss/&#123;name&#125;` | Elimina Kubernetes virtuale. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites` | Elenca siti virtuali. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites/&#123;name&#125;` | Ottieni sito virtuale. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites/&#123;name&#125;` | Elimina sito virtuale. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites/&#123;name&#125;/selectees` | Ottieni elementi selezionati. |
