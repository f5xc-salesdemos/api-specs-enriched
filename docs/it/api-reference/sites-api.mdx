...
description: Deployment cloud e edge node.
sidebar:
  hidden: true
i18n:
...
Integrazione VPC AWS, Azure, GCP con transit gateway. Selezione basata su label per l'applicazione delle policy tra regioni.
...
- Distribuire F5 XC su cloud provider (AWS, Azure, GCP)
- Gestire i deployment di siti XCKS (Managed Kubernetes) (precedentemente AppStack)
- Distribuire siti Secure Mesh per deployment edge orientati al networking
...
- **site**: Posizione di deployment fisica o cloud per servizi edge
- **virtual_site**: Raggruppamento logico di siti tramite selettori di label
...
| GET | `/api/data/namespaces/&#123;namespace&#125;/k8s_audit_logs/scroll` | Query di scorrimento log audit K8s. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/k8s_audit_logs/scroll` | Query di scorrimento log audit K8s. |
...
| GET | `/api/data/namespaces/&#123;namespace&#125;/vk8s_audit_logs/scroll` | Query di scorrimento log audit VK8s. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/vk8s_audit_logs/scroll` | Query di scorrimento log audit VK8s. |
...
| GET | `/api/web/namespaces/system/sites/&#123;site&#125;/global-kubeconfigs` | Elenca Kube Config globali. |
| POST | `/api/web/namespaces/system/sites/&#123;site&#125;/global-kubeconfigs` | Crea Kube Config globale. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/local-kubeconfig` | Crea Kube Config locale del cluster K8s. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/local-kubeconfigs` | Elenca Kube Config locali. |
...
| POST | `/api/data/namespaces/system/topology/dc_cluster_group/&#123;dc_cluster_group&#125;` | Topologia DC Cluster. |
| GET | `/api/data/namespaces/system/topology/dc_cluster_groups` | Riepilogo DC Cluster Groups. |
...
| GET | `/api/data/namespaces/system/topology/site_mesh_groups` | Riepilogo Site Mesh Groups. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/virtual_k8ss/&#123;metadata.name&#125;` | Sostituisci Virtual Kubernetes. |
