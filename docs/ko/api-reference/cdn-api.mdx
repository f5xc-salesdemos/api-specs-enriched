...
| POST | `/api/cdn/namespaces/&#123;namespace&#125;/cdn_loadbalancer/list-service-operations-status` | CDN 운영 명령 목록. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/cdn_loadbalancers/get_security_config` | CDN 로드밸런서 보안 구성 조회. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/cdn_loadbalancers/&#123;name&#125;/dos_automitigation_rules` | CDN 로드밸런서 DoS 자동 완화 규칙 조회. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/cdn_loadbalancers/&#123;name&#125;/dos_automitigation_rules/&#123;dos_automitigation_rule_name&#125;` | CDN 로드밸런서 DoS 자동 완화 규칙 삭제. |
...
| POST | `/api/cdn/namespaces/&#123;namespace&#125;/http_loadbalancer/list-service-operations-status` | 캐싱 활성화 시 HTTPLB 운영 명령 목록. |
