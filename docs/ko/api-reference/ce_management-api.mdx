...
이미지 다운로드 및 사전 업그레이드 검증을 포함한 토큰 기반 프로비저닝입니다. 플릿 그룹화를 통해 분산된 위치에서 대량 작업을 수행할 수 있습니다.
...
- Customer Edge 사이트 수명 주기 관리
- 네트워크 인터페이스 및 플릿 설정 구성
- 사이트 등록 및 토큰 워크플로우 처리
- 사전 업그레이드 점검을 포함한 사이트 업그레이드 실행
...
| GET | `/api/maurice/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/pre_upgrade_check` | 사전 업그레이드 점검. |
