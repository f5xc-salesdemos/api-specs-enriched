...
| POST | `/api/shape/dip/namespaces/system/bot/transactions` | 트랜잭션에 대한 봇 평가 조회. |
...
| GET | `/api/shape/alerts/namespaces/&#123;namespace&#125;/alert_templates` | BRM 알림 알림 템플릿 목록 조회. |
| GET | `/api/shape/alerts/namespaces/&#123;namespace&#125;/alert_templates/&#123;name&#125;` | 보호 도메인 조회. |
| DELETE | `/api/shape/alerts/namespaces/&#123;namespace&#125;/alert_templates/&#123;name&#125;` | BRM 알림 알림 템플릿 삭제. |
...
| DELETE | `/api/shape/csd/namespaces/&#123;namespace&#125;/script/justification/&#123;justification_id&#125;` | 스크립트 사유 삭제. |
...
| POST | `/api/shape/csd/namespaces/&#123;namespace&#125;/scripts/&#123;script_id&#125;/justification` | 스크립트 사유 업데이트. |
...
| POST | `/api/mobile/app-shield/namespaces/system/mobile-app-shield/addon/unsubscribe` | Mobile App Shield 구독 해제. |
| POST | `/api/mobile/integrator/namespaces/system/mobile-integrator/addon/subscribe` | Mobile Integrator 구독. |
| POST | `/api/mobile/integrator/namespaces/system/mobile-integrator/addon/unsubscribe` | Mobile Integrator 구독 해제. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/endpoints` | 리포트 엔드포인트. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/malicious/endpoints` | 악성 리포트 엔드포인트. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/malicious/transactions/asn` | 악성 리포트 트랜잭션 ASN. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/malicious/transactions/browser` | 악성 리포트 트랜잭션 브라우저. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/malicious/transactions/ip` | 악성 리포트 트랜잭션 IP. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/malicious/transactions/os` | 악성 리포트 트랜잭션 OS. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/malicious/transactions/ua` | 악성 리포트 트랜잭션 UA. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/top/type/malicious/dimension/apps/timeseries` | 악성 리포트 앱 시계열. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/traffic/dimension/attackintent/timeseries` | 전체 트래픽에 대한 공격 의도 시계열. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/traffic/dimension/categories/timeseries` | 전체 트래픽에 대한 카테고리 시계열. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/malicious/endpoints` | 악성 리포트 엔드포인트 V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/malicious/transactions/asn` | 악성 리포트 트랜잭션 ASN V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/malicious/transactions/browser` | 악성 리포트 트랜잭션 브라우저 V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/malicious/transactions/ip` | 악성 리포트 트랜잭션 IP V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/malicious/transactions/os` | 악성 리포트 트랜잭션 OS V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/malicious/transactions/ua` | 악성 리포트 트랜잭션 UA V2. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/top/type/malicious/dimension/apps/timeseries` | 악성 리포트 앱 시계열 V2. |
...
| POST | `/api/shape/bot/namespaces/system/bot-defense/addon/unsubscribe` | Shape Bot Defense 구독 해제. |
| POST | `/api/shape/bot/subscribe` | Shape Bot Defense 구독. |
| POST | `/api/shape/bot/unsubscribe` | Shape Bot Defense 구독 해제. |
...
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/block/feedback` | Safe 차단 피드백 전송. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/block/rule` | Safe 차단 규칙 전송. |
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/block/table` | SAFE 차단 테이블 목록 조회. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/ep` | Safe EP 전송. |
...
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/provision` | Safe 프로비저닝 전송. |
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/overview` | SAFE 개요 조회. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/overview` | Safe 개요 전송. |
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/top_locations` | SAFE 상위 위치 조회. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/top_locations` | SAFE 상위 위치 전송. |
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/top_sources` | SAFE 상위 소스 조회. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/top_sources` | SAFE 상위 소스 전송. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/transactions_over_time` | 시간별 Safe 트랜잭션 전송. |
...
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_details` | Safe 트랜잭션 상세 정보 전송. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_device_history` | Safe 트랜잭션 디바이스 이력 전송. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_locations` | Safe 트랜잭션 위치 전송. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_related_sessions` | Safe 트랜잭션 관련 세션 전송. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_timeline` | Safe 트랜잭션 타임라인 전송. |
