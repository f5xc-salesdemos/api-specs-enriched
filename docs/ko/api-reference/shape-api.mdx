...
| GET | `/api/shape/dip/namespaces/system/applications` | 애플리케이션 조회. |
| POST | `/api/shape/dip/namespaces/system/bot/asn` | 상위 ASN별 봇 평가 조회. |
| POST | `/api/shape/dip/namespaces/system/bot/transactions` | 트랜잭션 봇 평가 조회. |
...
| GET | `/api/shape/dip/namespaces/system/provision/regions` | 애플리케이션 트래픽 인사이트 가용 리전 조회. |
| GET | `/api/shape/dip/namespaces/system/status` | 애플리케이션 트래픽 인사이트 상태 조회. |
| POST | `/api/shape/dip/namespaces/system/validate/src_tag_injection` | JS 인젝션 검증. |
...
| PUT | `/api/shape/bot/custom/namespaces/&#123;namespace&#125;/bot_endpoint_policys/&#123;name&#125;` | 커스텀 봇 엔드포인트 정책 교체. |
...
| PUT | `/api/shape/bot/custom/namespaces/&#123;namespace&#125;/bot_allowlist_policys/&#123;name&#125;` | 커스텀 봇 허용 목록 정책 교체. |
...
| PUT | `/api/shape/bot/custom/namespaces/&#123;namespace&#125;/bot_network_policys/&#123;name&#125;` | 커스텀 봇 네트워크 정책 교체. |
...
| POST | `/api/shape/csd/namespaces/system/init` | 클라이언트 사이드 방어 활성화. |
...
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/js_configuration` | JS 인젝션 구성 조회. |
...
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/allowed_domains` | 클라이언트 사이드 방어 허용 도메인 목록 조회. |
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/allowed_domains/&#123;name&#125;` | 허용 도메인 조회. |
| DELETE | `/api/shape/csd/namespaces/&#123;namespace&#125;/allowed_domains/&#123;name&#125;` | 클라이언트 사이드 방어 허용 도메인 삭제. |
| POST | `/api/shape/csd/namespaces/&#123;metadata.namespace&#125;/protected_domains` | 보호 도메인 생성. |
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/protected_domains` | 클라이언트 사이드 방어 보호 도메인 목록 조회. |
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/protected_domains/&#123;name&#125;` | 보호 도메인 조회. |
| DELETE | `/api/shape/csd/namespaces/&#123;namespace&#125;/protected_domains/&#123;name&#125;` | 클라이언트 사이드 방어 보호 도메인 삭제. |
| POST | `/api/shape/csd/namespaces/&#123;metadata.namespace&#125;/mitigated_domains` | 완화 도메인 생성. |
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/mitigated_domains` | 클라이언트 사이드 방어 완화 도메인 목록 조회. |
| GET | `/api/shape/csd/namespaces/&#123;namespace&#125;/mitigated_domains/&#123;name&#125;` | 완화 도메인 조회. |
| DELETE | `/api/shape/csd/namespaces/&#123;namespace&#125;/mitigated_domains/&#123;name&#125;` | 클라이언트 사이드 방어 완화 도메인 삭제. |
| POST | `/api/shape/csd/namespaces/&#123;namespace&#125;/detectedDomains` | 모든 탐지된 도메인 목록 조회. |
| POST | `/api/shape/csd/namespaces/system/subscribe` | 클라이언트 사이드 방어 구독. |
| POST | `/api/shape/csd/namespaces/system/unsubscribe` | 클라이언트 사이드 방어 구독 취소. |
| POST | `/api/mobile/app-shield/namespaces/system/mobile-app-shield/addon/subscribe` | 모바일 앱 실드 구독. |
| POST | `/api/mobile/app-shield/namespaces/system/mobile-app-shield/addon/unsubscribe` | 모바일 앱 실드 구독 취소. |
| POST | `/api/mobile/integrator/namespaces/system/mobile-integrator/addon/subscribe` | 모바일 인테그레이터 구독. |
| POST | `/api/mobile/integrator/namespaces/system/mobile-integrator/addon/unsubscribe` | 모바일 인테그레이터 구독 취소. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/top/type/human/dimension/browser` | 상위 인간 브라우저. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/top/type/human/dimension/device` | 상위 인간 디바이스. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/top/type/human/dimension/geolocation` | 상위 인간 지리적 위치. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/top/type/human/dimension/platform` | 상위 인간 플랫폼. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/top/type/malicious/dimension/app` | 애플리케이션별 상위 악성 봇. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/top/type/malicious/dimension/apps/timeseries` | 악성 앱 시계열 보고. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/traffic/dimension/attackintent/timeseries` | 전체 트래픽 공격 의도 시계열. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/reporting/traffic/dimension/categories/timeseries` | 전체 트래픽 카테고리 시계열. |
...
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/top/type/human/dimension/browser` | 상위 인간 브라우저 V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/top/type/human/dimension/device` | 상위 인간 디바이스 V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/top/type/human/dimension/geolocation` | 상위 인간 지리적 위치 V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/top/type/human/dimension/platform` | 상위 인간 플랫폼 V2. |
| POST | `/api/shape/bot/namespaces/&#123;namespace&#125;/v2/reporting/top/type/malicious/dimension/apps/timeseries` | 악성 앱 시계열 보고 V2. |
...
| POST | `/api/shape/bot/reporting/peers/threat-types` | 위협 유형별 피어그룹. |
| POST | `/api/shape/bot/reporting/peers/top-good-bots` | 피어 그룹 상위 양성 봇. |
| POST | `/api/shape/bot/reporting/peers/top-reason-codes` | 피어그룹 상위 사유 코드. |
...
| POST | `/api/shape/bot/namespaces/system/bot-defense/addon/unsubscribe` | Shape 봇 방어 구독 취소. |
| POST | `/api/shape/bot/subscribe` | Shape 봇 방어 구독. |
| POST | `/api/shape/bot/unsubscribe` | Shape 봇 방어 구독 취소. |
...
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/block/feedback` | SAFE 차단 피드백 제출. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/block/rule` | SAFE 차단 규칙 제출. |
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/block/table` | SAFE 차단 테이블 목록 조회. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/ep` | SAFE 엔드포인트 제출. |
...
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/health` | 상태 확인 요청. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/provision` | SAFE 프로비저닝 제출. |
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/overview` | SAFE 개요 조회. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/overview` | SAFE 개요 제출. |
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/top_locations` | SAFE 상위 위치 조회. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/top_locations` | SAFE 상위 위치 제출. |
| GET | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/top_sources` | SAFE 상위 소스 조회. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/top_sources` | SAFE 상위 소스 제출. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/stats/transactions_over_time` | SAFE 시간별 트랜잭션 제출. |
...
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_details` | SAFE 트랜잭션 상세 제출. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_device_history` | SAFE 트랜잭션 디바이스 이력 제출. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_locations` | SAFE 트랜잭션 위치 제출. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_related_sessions` | SAFE 트랜잭션 관련 세션 제출. |
| POST | `/api/shape/safe/namespaces/&#123;namespace&#125;/safe/sas/transaction_timeline` | SAFE 트랜잭션 타임라인 제출. |
