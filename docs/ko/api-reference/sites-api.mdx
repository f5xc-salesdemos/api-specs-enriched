...
트랜짓 게이트웨이를 통한 AWS, Azure, GCP VPC 통합. 리전 간 정책 적용을 위한 레이블 기반 선택.
...
- 클라우드 제공업체(AWS, Azure, GCP) 전반에 F5 XC 배포
- XCKS(관리형 Kubernetes) 사이트 배포 관리(구 AppStack)
- 네트워킹 중심 에지 배포를 위한 Secure Mesh 사이트 배포
- 외부 Kubernetes 클러스터를 Customer Edge로 통합
- AWS VPC, Azure VNet 및 GCP VPC 사이트 구성
- 가상 사이트 및 사이트 정책 관리

## 주요 리소스

- **site**: 에지 서비스를 위한 물리적 또는 클라우드 배포 위치
- **virtual_site**: 레이블 셀렉터를 사용한 사이트의 논리적 그룹
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/aws_tgw_sites/&#123;metadata.name&#125;` | AWS TGW 사이트 대체. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_site/&#123;name&#125;/validate_config` | AWS TGW 구성 검증. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_tgw_sites` | AWS TGW 사이트 구성 목록. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/aws_vpc_sites/&#123;metadata.name&#125;` | AWS VPC 사이트 대체. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_site/&#123;name&#125;/storage/set_vpc_k8s_hostnames` | VPC K8s 호스트네임 구성. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_site/&#123;name&#125;/validate_config` | AWS VPC 사이트 구성 검증. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/aws_vpc_sites` | AWS VPC 사이트 구성 목록. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/voltstack_sites/&#123;metadata.name&#125;` | App Stack 사이트 대체. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/voltstack_sites` | App Stack 사이트 구성 목록. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/azure_vnet_sites/&#123;metadata.name&#125;` | Azure VNet 사이트 대체. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_site/&#123;name&#125;/validate_config` | Azure VNet 사이트 구성 검증. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/azure_vnet_sites` | Azure VNet 사이트 구성 목록. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/gcp_vpc_sites/&#123;metadata.name&#125;` | GCP VPC 사이트 대체. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_site/&#123;name&#125;/set_cloud_site_info` | GCP VPC 사이트 정보 구성. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_site/&#123;name&#125;/validate_config` | GCP VPC 사이트 구성 검증. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/gcp_vpc_sites` | GCP VPC 사이트 구성 목록. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/securemesh_sites/&#123;metadata.name&#125;` | Secure Mesh 사이트 대체. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_sites` | Secure Mesh 사이트 구성 목록. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/securemesh_site_v2s/&#123;metadata.name&#125;` | Secure Mesh 사이트 대체. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/securemesh_site_v2s` | Secure Mesh 사이트 구성 목록. |
...
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/k8s_clusters` | 구성 사양 생성. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/k8s_clusters/&#123;metadata.name&#125;` | 구성 사양 대체. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/k8s_clusters` | K8s 클러스터 목록. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/k8s_clusters/&#123;name&#125;` | 구성 사양 조회. |
...
| POST | `/api/web/namespaces/system/revoke/global-kubeconfigs` | 글로벌 Kubeconfig 폐기. |
| POST | `/api/data/namespaces/system/site/&#123;name&#125;/status` | 사이트 존재 여부 확인. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/configmaps` | ConfigMap 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/endpoints` | Endpoints 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces` | Namespace 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/configmaps` | ConfigMap 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/endpoints` | Endpoints 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/persistentvolumeclaims` | PersistentVolumeClaim 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/pods` | Pod 목록 |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/secrets` | Secret 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/namespaces/&#123;namespace&#125;/services` | Service 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/nodes` | Namespace 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/persistentvolumeclaims` | PersistentVolumeClaim 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/persistentvolumes` | PersistentVolume 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/pods` | Pod 목록 |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/secrets` | Secret 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/api/v1/services` | Service 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/daemonsets` | DaemonSet 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/deployments` | Deployment 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/daemonsets` | DaemonSet 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/deployments` | Deployment 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/replicasets` | ReplicaSet 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/namespaces/&#123;namespace&#125;/statefulsets` | StatefulSet 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/replicasets` | ReplicaSet 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/apps/v1/statefulsets` | StatefulSet 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1/jobs` | Job 목록 |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1/namespaces/&#123;namespace&#125;/jobs` | Job 목록 |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1beta1/cronjobs` | CronJob 목록. |
| GET | `/api/data/namespaces/system/site/&#123;site&#125;/apis/batch/v1beta1/namespaces/&#123;namespace&#125;/cronjobs` | CronJob 목록. |
...
| GET | `/api/web/namespaces/system/sites/&#123;site&#125;/global-kubeconfigs` | 글로벌 Kube Config 목록. |
| POST | `/api/web/namespaces/system/sites/&#123;site&#125;/global-kubeconfigs` | 글로벌 Kube Config 생성. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/sites/&#123;metadata.name&#125;` | 사이트 대체. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites` | 사이트 목록 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;` | 사이트 조회 |
| POST | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/local-kubeconfig` | K8s 클러스터 로컬 Kube Config 생성. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;name&#125;/local-kubeconfigs` | 로컬 Kube Config 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/global_networks` | 글로벌 네트워크 목록. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/segments` | 세그먼트 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/interface` | 인터페이스 목록. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/virtual_k8ss/&#123;metadata.name&#125;` | 가상 Kubernetes 대체. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/virtual_k8s/pvc/metrics` | PVC 메트릭. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_k8ss` | 가상 Kubernetes 목록. |
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/virtual_sites/&#123;metadata.name&#125;` | 가상 사이트 대체. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites` | 가상 사이트 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_sites/&#123;name&#125;/selectees` | 선택 대상 조회. |
