...
- 네트워킹 중심 엣지 배포를 위한 Secure Mesh 사이트 배포
...
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/k8s_clusters/&#123;metadata.name&#125;` | 구성 사양 교체. |
...
| POST | `/api/web/namespaces/system/revoke/global-kubeconfigs` | 글로벌 Kubeconfig 해지. |
