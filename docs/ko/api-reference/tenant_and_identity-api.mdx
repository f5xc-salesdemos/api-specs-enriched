...
| GET | `/api/web/namespaces/system/partner-management/customer_supports` | 하위 테넌트에서 생성된 모든 지원 티켓 목록 조회. |
...
| GET | `/api/web/custom/namespaces/&#123;namespace&#125;/roles` | 사용자 정의 역할 목록 조회. |
| POST | `/api/web/custom/namespaces/&#123;namespace&#125;/roles` | 사용자 정의 역할 생성. |
| GET | `/api/web/custom/namespaces/&#123;namespace&#125;/roles/&#123;name&#125;` | 사용자 정의 역할 조회. |
| PUT | `/api/web/custom/namespaces/&#123;namespace&#125;/roles/&#123;name&#125;` | 사용자 정의 역할 교체. |
...
| POST | `/api/scim/namespaces/system/v2/Groups` | 사용자를 포함한 그룹 생성. |
...
| POST | `/api/web/custom/namespaces/&#123;namespace&#125;/accept_tos` | 서비스 약관 동의. |
...
| GET | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 그룹 ID를 기반으로 그룹의 모든 세부 정보 조회. |
| DELETE | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 그룹 ID를 기반으로 그룹 삭제. |
| PUT | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 사용자 그룹 필드 / 접근 / 연결 교체. |
