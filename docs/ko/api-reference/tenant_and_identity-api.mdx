...
계정 보기 구성 및 관리자 알림 채널. 일회용 비밀번호 재설정, 프로비저닝 흐름 및 활성 연결 모니터링.
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/allowed_tenants` | 허용된 테넌트 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/authentications` | 인증 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/authorization_servers` | 인가 서버 목록. |
...
| GET | `/api/web/namespaces/system/partner-management/customer_supports` | 하위 테넌트에서 생성된 모든 지원 티켓 목록. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/child_tenants` | 하위 테넌트 목록. |
...
| GET | `/api/web/namespaces/system/partner-management/child_tenant_managers/&#123;name&#125;/child_tenants` | 지정된 하위 테넌트 관리자의 하위 테넌트 목록. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/child_tenant_managers` | 하위 테넌트 관리자 목록. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/contacts` | 연락처 목록. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/contacts/&#123;name&#125;` | 연락처 조회. |
| DELETE | `/api/web/namespaces/&#123;namespace&#125;/contacts/&#123;name&#125;` | 연락처 삭제. |
| GET | `/api/web/namespaces/system/managed_client/customer_supports` | 관리 테넌트의 티켓 목록. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/managed_tenants` | 관리 테넌트 목록. |
...
| GET | `/api/web/namespaces` | 네임스페이스 목록. |
| POST | `/api/web/namespaces` | 네임스페이스 생성. |
| POST | `/api/config/namespaces/system/all_application_inventory` | 모든 애플리케이션 객체 인벤토리. |
| POST | `/api/config/namespaces/system/all_application_inventory_waf_filters` | WAF 필터가 포함된 모든 애플리케이션 객체 인벤토리. |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/api_endpoints/stats` | 네임스페이스별 API 엔드포인트 통계 조회. |
...
| POST | `/api/web/namespaces/&#123;name&#125;/cascade_delete` | 연쇄 삭제. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/namespace_roles` | 네임스페이스 역할 목록. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/rbac_policys` | RBAC 정책 목록. |
| GET | `/api/web/namespaces/&#123;namespace&#125;/rbac_policys/&#123;name&#125;` | RBAC 정책 조회. |
| GET | `/api/web/custom/namespaces/&#123;namespace&#125;/roles` | 커스텀 역할 목록. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/roles` | 역할 목록 |
...
| GET | `/api/web/custom/namespaces/&#123;namespace&#125;/oidc_providers` | 목록 |
...
| PUT | `/api/web/custom/namespaces/&#123;namespace&#125;/oidc_providers/&#123;name&#125;/scim` | OIDC 제공자 SCIM 통합 업데이트. |
| GET | `/no_auth/countries/&#123;country_code&#125;/states/&#123;prefix&#125;` | 주/도 목록. |
| GET | `/no_auth/countries/&#123;country_code&#125;/states/&#123;state_code&#125;/cities/&#123;prefix&#125;` | 도시 목록. |
| GET | `/no_auth/countries/&#123;prefix&#125;` | 국가 목록. |
| POST | `/no_auth/login/validate_registration` | 등록 검증. |
| POST | `/no_auth/send_password_email` | 비밀번호 이메일 발송. |
| GET | `/no_auth/signup/&#123;name&#125;` | 가입 읽기. |
| POST | `/no_auth/validate_contact` | 연락처 검증. |
| GET | `/api/web/custom/countries/&#123;country_code&#125;/states/&#123;prefix&#125;` | 주/도 목록. |
| GET | `/api/web/custom/countries/&#123;country_code&#125;/states/&#123;state_code&#125;/cities/&#123;prefix&#125;` | 도시 목록. |
| GET | `/api/web/custom/countries/&#123;prefix&#125;` | 국가 목록. |
| GET | `/api/scim/namespaces/system/v2/Groups` | 필터 기반 그룹 목록. |
| POST | `/api/scim/namespaces/system/v2/Groups` | 사용자와 함께 그룹 생성. |
| GET | `/api/scim/namespaces/system/v2/Groups/&#123;id&#125;` | ID 기반 그룹 목록. |
...
| GET | `/api/scim/namespaces/system/v2/ServiceProviderConfig` | 서비스 제공자 구성 목록. |
...
| GET | `/api/web/namespaces/system/tenant/idm/users/inactive` | 비활성 사용자 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/tenant_configurations` | 테넌트 구성 목록. |
...
| POST | `/api/web/namespaces/system/tenant_management/delegated_access/unsubscribe` | 위임 액세스 애드온 서비스 구독 취소. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/tenant_profiles` | 테넌트 프로필 목록. |
...
| GET | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 그룹 ID로 그룹의 모든 세부 정보 조회. |
| DELETE | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 그룹 ID로 그룹 삭제. |
| PUT | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 사용자 그룹 필드 / 액세스 / 연결 교체. |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/user_groups` | 사용자 그룹 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/user_identifications` | 사용자 식별 목록. |
...
- [대화형 API 레퍼런스](./tenant_and_identity/)
