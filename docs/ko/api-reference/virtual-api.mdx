---
title: ⚖️ Virtual API
description: '오리진 풀을 활용한 HTTP, TCP, UDP 로드 밸런싱.'
sidebar:
  hidden: true
i18n:
...
라우팅 규칙을 사용한 리전 간 트래픽 분배. 헬스 체크 및 장애 조치 정책.
...
- **tcp_loadbalancer**: 비HTTP 프로토콜 트래픽을 위한 레이어 4 TCP/UDP 로드 밸런서
...
- **malicious_user_detection**: 악의적 사용자 행위의 자동 탐지 및 완화
