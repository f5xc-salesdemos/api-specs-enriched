---
title: ⚖️ Virtual API
description: 'HTTP, TCP, UDP 로드 밸런싱과 오리진 풀.'
sidebar:
  hidden: true
i18n:
...
라우팅 규칙을 통한 리전 간 트래픽 분배. 헬스 체크 및 장애 조치 정책.
...
- **http_loadbalancer**: 애플리케이션 트래픽 분배를 위한 레이어 7 HTTP/HTTPS 로드 밸런서
- **tcp_loadbalancer**: 비 HTTP 프로토콜 트래픽을 위한 레이어 4 TCP/UDP 로드 밸런서
- **origin_pool**: 로드 밸런서 트래픽 분배를 위한 백엔드 서버 그룹
- **healthcheck**: 오리진 서버 가용성을 위한 헬스 모니터링 구성
- **app_firewall**: HTTP 트래픽 보호를 위한 웹 애플리케이션 방화벽 정책
- **service_policy**: 서비스 수준 접근 제어 및 트래픽 관리 규칙
- **malicious_user_detection**: 악성 사용자 행위의 자동 탐지 및 완화
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/app_firewalls` | 애플리케이션 방화벽 목록. |
...
| POST | `/api/data/namespaces/system/app_security/all_ns_search/loadbalancers` | 전체 네임스페이스 로드 밸런서 검색. |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/search/loadbalancers` | 로드 밸런서 검색. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/suspicious_user_logs` | 의심스러운 사용자 로그 쿼리. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/suspicious_user_logs/aggregation` | 의심스러운 사용자 로그 집계 쿼리. |
| GET | `/api/data/namespaces/&#123;namespace&#125;/app_security/suspicious_user_logs/scroll` | 의심스러운 사용자 로그 스크롤 쿼리. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/suspicious_user_logs/scroll` | 의심스러운 사용자 로그 스크롤 쿼리. |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/data_exposure/suggestion` | 민감 데이터 규칙 제안. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/ddos_mitigation/suggestion` | DDoS 완화 규칙 제안. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/oas_validation/suggestion` | Open API 사양 검증 규칙 제안. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/clusters` | 클러스터 목록. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/clusters/&#123;name&#125;` | 클러스터 조회. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/clusters/&#123;name&#125;` | 클러스터 삭제. |
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/http_loadbalancers` | HTTP 로드 밸런서 생성. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/http_loadbalancers/&#123;metadata.name&#125;` | HTTP 로드 밸런서 교체. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers` | HTTP 로드 밸런서 구성 목록. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/get_security_config` | HTTP 로드 밸런서 보안 구성 조회. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;` | HTTP 로드 밸런서 조회. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;` | HTTP 로드 밸런서 구성 삭제. |
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/api_definitions/assign` | API 정의 할당. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/api_definitions/available` | 사용 가능한 API 정의 목록. |
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/api_endpoints` | API 엔드포인트 조회. |
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/api_endpoints/swagger_spec` | HTTP 로드 밸런서 Swagger 사양 조회. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/dos_automitigation_rules` | HTTP 로드 밸런서 DoS 자동 완화 규칙 조회. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/dos_automitigation_rules/&#123;dos_automitigation_rule_name&#125;` | HTTP 로드 밸런서 DoS 자동 완화 규칙 삭제. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/protocol_inspections` | 프로토콜 검사 구성 목록. |
...
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/tcp_loadbalancers` | TCP 로드 밸런서 생성. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/tcp_loadbalancers/&#123;metadata.name&#125;` | TCP 로드 밸런서 교체. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/tcp_loadbalancers` | TCP 로드 밸런서 구성 목록. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/tcp_loadbalancers/&#123;name&#125;` | TCP 로드 밸런서 조회. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/tcp_loadbalancers/&#123;name&#125;` | TCP 로드 밸런서 구성 삭제. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/tcp_loadbalancers/&#123;name&#125;/get-dns-info` | DNS 정보 조회. |
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/udp_loadbalancers` | UDP 로드 밸런서 생성. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/udp_loadbalancers/&#123;metadata.name&#125;` | UDP 로드 밸런서 교체. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/udp_loadbalancers` | UDP 로드 밸런서 구성 목록. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/udp_loadbalancers/&#123;name&#125;` | UDP 로드 밸런서 조회. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/udp_loadbalancers/&#123;name&#125;` | UDP 로드 밸런서 구성 삭제. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/udp_loadbalancers/&#123;name&#125;/get-dns-info` | DNS 정보 조회. |
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/enhanced_firewall_policys` | 향상된 방화벽 정책 생성. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/enhanced_firewall_policys/&#123;metadata.name&#125;` | 향상된 방화벽 정책 교체. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/enhanced_firewall_policy/hits` | 향상된 방화벽 정책 적중. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/enhanced_firewall_policys` | 향상된 방화벽 정책 목록. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/enhanced_firewall_policys/&#123;name&#125;` | 향상된 방화벽 정책 조회. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/enhanced_firewall_policys/&#123;name&#125;` | 향상된 방화벽 정책 삭제. |
| POST | `/api/config/namespaces/system/malware_protection/addon/subscribe` | 악성 코드 보호 구독. |
| POST | `/api/config/namespaces/system/malware_protection/addon/unsubscribe` | 악성 코드 보호 구독 해지. |
...
| GET | `/api/config/dns/namespaces/&#123;namespace&#125;/geo_location_sets` | 지리적 위치 세트 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/healthchecks` | 헬스 체크 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/origin_pools` | 오리진 풀 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/proxies` | 프록시 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/rate_limiter_policys` | 속도 제한기 정책 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/service_policy_rules` | 서비스 정책 규칙 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/service_policy_sets` | 서비스 정책 세트 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_hosts` | 가상 호스트 목록. |
...
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/stats` | 가상 호스트 API 엔드포인트 통계 조회. |
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/summary/calls_by_response_code` | 가상 호스트 전체 API 호출 조회. |
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/summary/top_active` | 가상 호스트 상위 API 엔드포인트 조회. |
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/summary/top_sensitive_data` | 가상 호스트 민감 데이터 요약 조회. |
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/swagger_spec` | 앱 타입 Swagger 사양 조회. |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/create_ticket` | 취약점 티켓 생성. |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/vulnerabilities` | 가상 호스트 취약점 조회. |
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/vulnerability/update_state` | 가상 호스트 취약점 업데이트. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/client/rule_hits` | 클라이언트 규칙 적중 메트릭. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/client/security_events` | 클라이언트 보안 이벤트 메트릭. |
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/server/rule_hits` | 서버 규칙 적중 메트릭. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/waf_exclusion_policys` | WAF 제외 정책 목록. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;vh_name&#125;/active_staged_signatures` | 활성 스테이징 시그니처. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;vh_name&#125;/released_signatures` | 릴리스된 시그니처. |
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;vh_name&#125;/staged_signatures` | 스테이징 시그니처. |

## 링크

- [인터랙티브 API 레퍼런스](./virtual/)
