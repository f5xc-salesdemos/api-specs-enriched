...
Conexões com provedores multi-nuvem com peering de gateway e configuração de caminho de rede. Integração com cofre de credenciais e enumeração de sub-redes.
...
- [JSON da Especificação OpenAPI](../specifications/api/cloud_infrastructure.json)
