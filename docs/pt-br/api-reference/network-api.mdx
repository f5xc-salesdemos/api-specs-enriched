...
| GET | `/api/config/namespaces/&#123;namespace&#125;/address_allocators` | Listar Alocadores de Endereços. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/advertise_policys` | Listar Políticas de Anúncio. |
...
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/bgp_asn_sets` | Criar Conjunto ASN BGP. |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/bgp_asn_sets/&#123;metadata.name&#125;` | Substituir Conjunto ASN BGP. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/bgp_asn_sets` | Listar Conjuntos ASN BGP. |
| GET | `/api/config/namespaces/&#123;namespace&#125;/bgp_asn_sets/&#123;name&#125;` | Obter Conjunto ASN BGP. |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/bgp_asn_sets/&#123;name&#125;` | Excluir Conjunto ASN BGP. |
| GET | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/bgp_peers` | Mostrar Informações de Peers BGP. |
| GET | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/bgp_routes` | Mostrar Rotas BGP. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/bgp_routing_policys` | Listar Políticas de Roteamento BGP. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/dc_cluster_groups` | Listar Grupos de Cluster DC. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/forwarding_classs` | Listar Classes de Encaminhamento. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ike1s` | Listar Perfis IKE Fase 1. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ike_phase1_profiles` | Listar Perfis IKE Fase 1. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ike2s` | Listar Perfis IKE Fase 2. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ike_phase2_profiles` | Listar Perfis IKE Fase 2. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/ip_prefix_sets` | Listar Conjuntos de Prefixos IP. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/network_connectors` | Listar Conectores de Rede. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/public_ips` | Listar IPs Públicos. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/routes` | Listar Rotas. |
...
| POST | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/routes` | Mostrar Rotas. |
| POST | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/simplified_routes` | Mostrar Rotas Simplificadas. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/srv6_network_slices` | Listar Fatias de Rede SRv6. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/subnets` | Listar Sub-redes. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/tunnels` | Listar Túneis. |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_networks` | Listar Redes Virtuais. |
