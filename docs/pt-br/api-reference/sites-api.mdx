...
- Gerenciar sites virtuais e políticas de site
...
| POST | `/api/data/namespaces/system/topology/dc_cluster_group/&#123;dc_cluster_group&#125;` | Topologia do DC Cluster. |
| GET | `/api/data/namespaces/system/topology/dc_cluster_groups` | Resumo dos Grupos de DC Cluster. |
...
| POST | `/api/data/namespaces/system/topology/site_mesh_group/&#123;site_mesh_group&#125;` | Topologia do Site Mesh. |
| GET | `/api/data/namespaces/system/topology/site_mesh_groups` | Resumo dos Grupos de Site Mesh. |
