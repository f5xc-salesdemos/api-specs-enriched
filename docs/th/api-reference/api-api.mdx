...
description: คำนิยามอินเทอร์เฟซ การตรวจสอบสคีมา และการจัดกลุ่ม
sidebar:
  hidden: true
i18n:
...
การจัดทำรายการทรัพยากรพร้อมการจำแนกประเภทอัตโนมัติและการกำหนดโปรไฟล์ความปลอดภัย ลำดับชั้นขององค์กรแบ่งส่วนการเข้าถึงตามฟังก์ชันหรือนโยบายการป้องกัน
...
- **api_definition**: คำนิยามสคีมา API สำหรับการค้นพบและการป้องกัน
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/api_sec/rule_suggestion/data_exposure` | แนะนำกฎข้อมูลที่มีความละเอียดอ่อน |
...
- [ไฟล์ JSON ข้อกำหนด OpenAPI](../specifications/api/api.json)
