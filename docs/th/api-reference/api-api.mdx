...
description: การกำหนดอินเทอร์เฟซ การตรวจสอบสคีมา และการจัดกลุ่ม
sidebar:
  hidden: true
i18n:
...
การจัดหมวดหมู่ทรัพยากรพร้อมการจำแนกประเภทอัตโนมัติและการสร้างโปรไฟล์ด้านความปลอดภัย ลำดับชั้นขององค์กรแบ่งส่วนการเข้าถึงตามฟังก์ชันหรือนโยบายการป้องกัน
...
- **api_definition**: การกำหนดสคีมา API สำหรับการค้นพบและการป้องกัน
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/api_crawlers/&#123;name&#125;` | ดึง API crawler |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/api_definitions/&#123;name&#125;` | ดึง API Definition |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/api_definitions/&#123;name&#125;` | ลบ API Definition |
| GET | `/api/config/namespaces/&#123;namespace&#125;/api_definitions/&#123;name&#125;/loadbalancers` | ดึง Loadbalancer ที่อ้างอิง |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/api_definitions/&#123;name&#125;/unmark_as_non_api` | ยกเลิกเครื่องหมายเป็นไม่ใช่ API |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/api_discoverys/&#123;name&#125;` | ดึง API Discovery |
...
| GET | `/api/web/namespaces/&#123;namespace&#125;/api_groups/&#123;name&#125;` | ดึง API Group |
| GET | `/api/web/namespaces/&#123;namespace&#125;/api_group_elements` | แสดงรายการ API Group Element |
| GET | `/api/web/namespaces/&#123;namespace&#125;/api_group_elements/&#123;name&#125;` | ดึง API Group Element |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/api_testings/&#123;name&#125;` | ดึง API testing |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/app_api_groups/&#123;name&#125;` | ดึง API Group |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/api_sec/rule_suggestion/data_exposure` | แนะนำกฎข้อมูลที่มีความอ่อนไหว |
| POST | `/api/config/namespaces/&#123;namespace&#125;/api_sec/rule_suggestion/oas_validation` | แนะนำกฎการตรวจสอบ Open API specification |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/code_base_integrations/&#123;name&#125;` | ดึง Code Base Integration |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/discoverys/&#123;name&#125;` | ดึง Discovery |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/discoverys/&#123;name&#125;` | ลบ Discovery |

## ลิงก์

- [เอกสารอ้างอิง API แบบโต้ตอบ](./api/)
- [ข้อมูลจำเพาะ OpenAPI JSON](../specifications/api/api.json)
