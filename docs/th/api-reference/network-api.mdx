...
โปรโตคอล Border Gateway Protocol พร้อมการจัดการ ASN และความสัมพันธ์ของระบบอัตโนมัติ VPN แบบ site-to-site ที่เชื่อมต่อศูนย์ข้อมูลผ่านช่องทางที่เข้ารหัส
...
- กำหนดค่าการ routing BGP และการจัดการ ASN
...
- [ไฟล์ข้อกำหนด OpenAPI JSON](../specifications/api/network.json)
