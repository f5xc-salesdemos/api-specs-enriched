...
description: 'BGP peering, IPsec tunnels และ segment policies'
sidebar:
  hidden: true
i18n:
...
โปรโตคอล Border Gateway Protocol พร้อมการจัดการ ASN และความสัมพันธ์ของ Autonomous System VPN แบบ Site-to-Site ที่เชื่อมต่อศูนย์ข้อมูลผ่านช่องทางที่เข้ารหัส
...
- กำหนดค่า BGP routing และการจัดการ ASN
- จัดการ IPsec tunnels และ IKE phases
- กำหนดค่า network connectors และ routes
- จัดการ SRv6 และ subnetting
- กำหนดการเชื่อมต่อ segment และนโยบาย
- กำหนดค่า IP prefix sets

## ทรัพยากรหลัก

- **virtual_network**: เครือข่ายเสมือนสำหรับการเชื่อมต่อไซต์และการแบ่งเซกเมนต์
...
| GET | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/bgp_routes` | แสดง BGP Routes |
...
| POST | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/routes` | แสดง Routes |
| POST | `/api/operate/namespaces/&#123;namespace&#125;/sites/&#123;site&#125;/ver/simplified_routes` | แสดง Simplified Routes |
...
- [ไฟล์ข้อกำหนด OpenAPI แบบ JSON](../specifications/api/network.json)
