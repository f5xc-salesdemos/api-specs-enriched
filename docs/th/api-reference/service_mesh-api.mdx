...
คำจำกัดความประเภทแอปพลิเคชันพร้อมการค้นพบและการวิเคราะห์สคีมาที่เรียนรู้ได้ การอนุมานรูปแบบทราฟฟิกสำหรับการจัดการคำขออัจฉริยะ
...
- [ข้อกำหนด OpenAPI JSON](../specifications/api/service_mesh.json)
