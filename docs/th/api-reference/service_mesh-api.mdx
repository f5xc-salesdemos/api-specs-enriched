...
คำนิยามประเภทแอปพลิเคชันพร้อมการค้นพบและการวิเคราะห์สคีมาที่เรียนรู้ได้ การอนุมานรูปแบบทราฟฟิกสำหรับการจัดการคำขออัจฉริยะ
...
- **endpoint**: endpoint ของ service mesh สำหรับการกำหนดเส้นทางทราฟฟิก
...
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/app_settings/&#123;name&#125;/suspicious_users` | ดึงสถานะผู้ใช้ที่น่าสงสัย |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/app_types/&#123;app_type_name&#125;/api_endpoint/learnt_schema` | ดึงสคีมาที่เรียนรู้ได้ต่อ API endpoint |
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/app_types/&#123;app_type_name&#125;/api_endpoint/pdf` | ดึง PDF |
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/app_types/&#123;app_type_name&#125;/api_endpoints` | ดึง API endpoints |
...
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/app_types/&#123;app_type_name&#125;/overrides` | ดึง Override |
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/app_types/&#123;app_type_name&#125;/services/&#123;service_name&#125;/api_endpoint/pdf` | ดึง Service API Endpoint PDF |
...
| POST | `/api/maurice/software_os_version` | ดึง OS ตาม SW_VERSION |
...
- [ไฟล์ข้อกำหนด OpenAPI รูปแบบ JSON](../specifications/api/service_mesh.json)
