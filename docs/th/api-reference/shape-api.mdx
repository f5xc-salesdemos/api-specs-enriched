...
การจดจำภัยคุกคามด้วยการวิเคราะห์พฤติกรรมและการพิมพ์ลายนิ้วมืออุปกรณ์ การผสานรวม Mobile SDK สำหรับการป้องกันแอปพลิเคชัน
...
- **shape_app_firewall**: Shape application firewall สำหรับการป้องกันขั้นสูง
...
- [ไฟล์ข้อกำหนด OpenAPI รูปแบบ JSON](../specifications/api/shape.json)
