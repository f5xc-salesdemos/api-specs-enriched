...
การกระจายทราฟฟิกข้ามภูมิภาคด้วยกฎการกำหนดเส้นทาง การตรวจสอบสุขภาพและนโยบายการเฟลโอเวอร์
...
- กำหนดค่า proxy และนโยบายการส่งต่อ
- จัดการการป้องกันมัลแวร์และแคมเปญภัยคุกคาม
- กำหนดค่าการตรวจสอบสุขภาพและการตรวจสอบ endpoint

## ทรัพยากรหลัก

- **http_loadbalancer**: Layer 7 HTTP/HTTPS load balancer สำหรับการกระจายทราฟฟิกแอปพลิเคชัน
- **tcp_loadbalancer**: Layer 4 TCP/UDP load balancer สำหรับทราฟฟิกโปรโตคอลที่ไม่ใช่ HTTP
...
- **malicious_user_detection**: การตรวจจับและบรรเทาพฤติกรรมผู้ใช้ที่เป็นอันตรายแบบอัตโนมัติ
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents` | คิวรีเหตุการณ์ด้านความปลอดภัย |
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents/aggregation` | คิวรีการรวมเหตุการณ์ด้านความปลอดภัย |
| GET | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents/scroll` | คิวรีเลื่อนเหตุการณ์ด้านความปลอดภัย |
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents/scroll` | คิวรีเลื่อนเหตุการณ์ด้านความปลอดภัย |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/rate_limit/suggestion` | แนะนำกฎการจำกัดอัตรา |
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/trust_client/suggestion` | แนะนำกฎการไว้วางใจไคลเอนต์ |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/dos_automitigation_rules` | GET กฎการบรรเทา DoS อัตโนมัติสำหรับ HTTP Load Balancer |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/dos_automitigation_rules/&#123;dos_automitigation_rule_name&#125;` | DELETE กฎการบรรเทา DoS อัตโนมัติสำหรับ HTTP Load Balancer |
| GET | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/get-dns-info` | GET ข้อมูล DNS |
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/l7ddos_rps_threshold` | ตั้งค่าเกณฑ์ L7 DDoS RPS |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/enhanced_firewall_policy/hits` | จำนวนการเข้าถึง Enhanced Firewall Policy |
...
| POST | `/api/config/namespaces/system/malware_protection/addon/subscribe` | สมัครสมาชิกการป้องกันมัลแวร์ |
| POST | `/api/config/namespaces/system/malware_protection/addon/unsubscribe` | ยกเลิกสมาชิกการป้องกันมัลแวร์ |
...
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoint/learnt_schema` | GET Schema ที่เรียนรู้ต่อ API endpoint |
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoint/pdf` | GET PDF ของ API Endpoint |
| GET | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoint/sources_openapi_schema` | GET OpenApi schema ต้นทางที่เกี่ยวข้องต่อ API endpoint |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/summary/calls_by_response_code` | GET การเรียก API ทั้งหมดสำหรับ Virtual Host |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/client/rule_hits` | เมตริกจำนวนการเข้าถึงกฎฝั่งไคลเอนต์ |
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/client/security_events` | เมตริกเหตุการณ์ความปลอดภัยฝั่งไคลเอนต์ |
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/server/rule_hits` | เมตริกจำนวนการเข้าถึงกฎฝั่งเซิร์ฟเวอร์ |
