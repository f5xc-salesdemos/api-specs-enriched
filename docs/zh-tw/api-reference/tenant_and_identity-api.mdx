...
description: 使用者設定檔、工作階段和 OTP 設定。
sidebar:
  hidden: true
i18n:
...
帳戶檢視設定和管理員警報頻道。一次性密碼重設、佈建流程和作用中連線監控。
...
| POST | `/api/web/namespaces/system/managed_client/customer_supports/&#123;tp_id&#125;/comment` | 在受管理租戶中的客戶支援工單新增評論。 |
...
| GET | `/api/web/namespaces/system/managed_tenants_by_user` | 取得依使用者分類的受管理租戶列表。 |
| GET | `/api/web/namespaces/system/managed_tenants_list` | 取得受管理租戶列表。 |
| GET | `/api/web/namespaces/system/support-tenant/managed_tenants` | 依使用者列出用於支援操作的受管理租戶。 |
...
| POST | `/api/config/namespaces/system/update_allow_advertise_on_public` | 更新允許在公用網路上通告。 |
| POST | `/api/config/namespaces/system/validate_rules` | 驗證規則。 |
| PUT | `/api/web/namespaces/&#123;metadata.name&#125;` | 取代命名空間。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/active_alert_policies` | 取得作用中警報政策。 |
| POST | `/api/config/namespaces/&#123;namespace&#125;/active_alert_policies` | 設定作用中警報政策。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/active_network_policies` | 取得作用中網路政策。 |
| POST | `/api/config/namespaces/&#123;namespace&#125;/active_network_policies` | 設定作用中網路政策。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/active_service_policies` | 取得作用中服務政策。 |
| POST | `/api/config/namespaces/&#123;namespace&#125;/active_service_policies` | 設定作用中服務政策。 |
...
| GET | `/api/scim/namespaces/system/v2/ServiceProviderConfig` | 列出服務提供者設定。 |
...
| PUT | `/api/scim/namespaces/system/v2/Users/&#123;id&#125;` | 更新使用者和角色指派。 |
...
| GET | `/api/web/namespaces/system/tenant/idm/users/inactive` | 列出非作用中使用者。 |
...
| GET | `/api/web/namespaces/system/tenant/settings/tenant/image` | 租戶個人資料圖片。 |
| DELETE | `/api/web/namespaces/system/tenant/settings/tenant/image` | 刪除租戶個人資料圖片。 |
| PUT | `/api/web/namespaces/system/tenant/settings/tenant/image` | 更新租戶個人資料圖片。 |
...
| GET | `/api/web/static/namespaces/system/tenant/settings/tenant/image` | 租戶個人資料圖片。 |
| GET | `/api/config/tenants/&#123;tenant&#125;/summary` | 摘要 |
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/tenant_configurations` | 建立租戶設定。 |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/tenant_configurations/&#123;metadata.name&#125;` | 取代租戶設定。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/tenant_configurations` | 列出租戶設定。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/tenant_configurations/&#123;name&#125;` | 取得租戶設定。 |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/tenant_configurations/&#123;name&#125;` | 刪除租戶設定。 |
...
| POST | `/api/web/custom/namespaces/&#123;namespace&#125;/role_users` | 指派角色給使用者。 |
| POST | `/api/web/custom/namespaces/&#123;namespace&#125;/send_password_email` | 傳送密碼電子郵件。 |
| GET | `/api/web/custom/namespaces/&#123;namespace&#125;/tos` | 取得服務條款 |
| GET | `/api/web/custom/namespaces/&#123;namespace&#125;/user_roles` | 取得使用者和角色指派。 |
| POST | `/api/web/custom/namespaces/&#123;namespace&#125;/user_roles` | 建立含角色指派的使用者。 |
| PUT | `/api/web/custom/namespaces/&#123;namespace&#125;/user_roles` | 更新使用者和角色指派。 |
| POST | `/api/web/custom/namespaces/&#123;namespace&#125;/user_roles/&#123;name&#125;` | 更新使用者和角色指派。 |
...
| GET | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 依群組 ID 擷取群組的所有詳細資料。 |
| DELETE | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 依群組 ID 刪除群組。 |
| PUT | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 取代使用者群組欄位/存取權限/關聯。 |
| PUT | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;/assign_namespace_roles` | 指派角色給使用者群組。 |
...
| GET | `/api/web/namespaces/system/user/settings/image` | 取得使用者個人資料圖片。 |
