...
description: 使用者設定檔、工作階段與 OTP 設定。
sidebar:
  hidden: true
i18n:
...
帳戶檢視設定與管理員警報頻道。一次性密碼重設、佈建流程與作用中連線監控。
...
| GET | `/api/web/namespaces/system/partner-management/child_tenants` | 子租戶清單。 |
...
| POST | `/api/web/namespaces/system/partner-management/customer_supports/&#123;tp_id&#125;/comment` | 新增評論至子租戶中的客戶支援工單。 |
...
| POST | `/api/web/namespaces/system/managed_client/customer_supports/&#123;tp_id&#125;/comment` | 新增評論至受管理租戶中的客戶支援工單。 |
...
| GET | `/api/web/namespaces/system/managed_tenants_by_user` | 取得依使用者分類的受管理租戶清單。 |
| GET | `/api/web/namespaces/system/managed_tenants_list` | 取得受管理租戶清單。 |
| GET | `/api/web/namespaces/system/support-tenant/managed_tenants` | 依使用者列出支援作業的受管理租戶。 |
...
| POST | `/api/config/namespaces/system/all_application_inventory` | 所有應用程式物件清查。 |
| POST | `/api/config/namespaces/system/all_application_inventory_waf_filters` | 含 WAF 篩選條件的所有應用程式物件清查。 |
...
| POST | `/api/config/namespaces/system/networking_inventory` | 網路物件清查。 |
| POST | `/api/cloud-data/namespaces/system/suggest-values` | 建議值。 |
| POST | `/api/config/namespaces/system/update_allow_advertise_on_public` | 更新允許在公開環境上通告。 |
| POST | `/api/config/namespaces/system/validate_rules` | 驗證規則。 |
| PUT | `/api/web/namespaces/&#123;metadata.name&#125;` | 取代命名空間。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/active_alert_policies` | 取得作用中的警報原則。 |
| POST | `/api/config/namespaces/&#123;namespace&#125;/active_alert_policies` | 設定作用中的警報原則。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/active_network_policies` | 取得作用中的網路原則。 |
| POST | `/api/config/namespaces/&#123;namespace&#125;/active_network_policies` | 設定作用中的網路原則。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/active_service_policies` | 取得作用中的服務原則。 |
| POST | `/api/config/namespaces/&#123;namespace&#125;/active_service_policies` | 設定作用中的服務原則。 |
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/api_endpoints/stats` | 取得命名空間的 API 端點統計資料。 |
| POST | `/api/config/namespaces/&#123;namespace&#125;/application_inventory` | 應用程式物件清查。 |
...
| GET | `/api/web/namespaces/system/tenant/idm/users/inactive` | 列出非作用中的使用者。 |
...
| PUT | `/api/web/custom/namespaces/system/users/group_remove` | 從群組中移除使用者。 |
...
| POST | `/api/web/custom/namespaces/system/user_groups/analyze_for_deletion` | 分析刪除作業。 |
| GET | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 根據群組 ID 擷取群組的所有詳細資訊。 |
| DELETE | `/api/web/custom/namespaces/system/user_groups/&#123;name&#125;` | 根據群組 ID 刪除群組。 |
