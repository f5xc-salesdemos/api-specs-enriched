...
- **malicious_user_detection**：自動偵測與緩解惡意使用者行為
...
| POST | `/api/data/namespaces/system/app_security/all_ns_events/aggregation` | 所有命名空間安全事件彙總查詢。 |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/events/aggregation` | 安全事件彙總查詢。 |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents/aggregation` | 安全事件彙總查詢。 |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/suspicious_user_logs/aggregation` | 可疑使用者日誌彙總查詢。 |
...
| POST | `/api/ml/data/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;name&#125;/api_endpoints/summary/calls_by_response_code` | 取得虛擬主機的 API 總呼叫數。 |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;vh_name&#125;/active_staged_signatures` | 已啟用的暫存簽章。 |
