...
| POST | `/api/data/namespaces/system/app_security/all_ns_events` | 所有命名空間安全事件查詢。 |
| POST | `/api/data/namespaces/system/app_security/all_ns_events/aggregation` | 所有命名空間安全事件聚合查詢。 |
| POST | `/api/data/namespaces/system/app_security/all_ns_search/loadbalancers` | 搜尋所有命名空間負載平衡器。 |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents` | 安全事件查詢。 |
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents/aggregation` | 安全事件聚合查詢。 |
| GET | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents/scroll` | 安全事件捲動查詢。 |
| POST | `/api/data/namespaces/&#123;namespace&#125;/app_security/incidents/scroll` | 安全事件捲動查詢。 |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/api_endpoint_protection/suggestion` | 建議 API 端點防護規則。 |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/get_security_config` | 取得 HTTP 負載平衡器安全設定。 |
...
| POST | `/api/config/namespaces/&#123;namespace&#125;/http_loadbalancers/&#123;name&#125;/l7ddos_rps_threshold` | 設定 L7 DDoS RPS 閾值。 |
| POST | `/api/config/namespaces/&#123;metadata.namespace&#125;/protocol_inspections` | 建立協定檢查。 |
| PUT | `/api/config/namespaces/&#123;metadata.namespace&#125;/protocol_inspections/&#123;metadata.name&#125;` | 取代協定檢查。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/protocol_inspections` | 列出設定協定檢查。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/protocol_inspections/&#123;name&#125;` | 取得協定檢查。 |
| DELETE | `/api/config/namespaces/&#123;namespace&#125;/protocol_inspections/&#123;name&#125;` | 刪除設定協定檢查。 |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/enhanced_firewall_policy/hits` | 增強型防火牆策略命中數。 |
...
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/server/rule_hits` | 伺服器端規則命中指標。 |
| POST | `/api/data/namespaces/&#123;namespace&#125;/wafs/metrics/server/security_events` | 伺服器端安全事件指標。 |
...
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;vh_name&#125;/active_staged_signatures` | 啟用中的暫存簽章。 |
| GET | `/api/config/namespaces/&#123;namespace&#125;/virtual_hosts/&#123;vh_name&#125;/released_signatures` | 已發佈簽章。 |
