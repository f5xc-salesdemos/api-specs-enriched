...
class TestPatternCoverage:
    ...
    @pytest.mark.parametrize("field_name,expected_category", [
        ('username', 'identity'),
        ('email', 'communication'),
        ('phone', 'communication'),
        ('uuid', 'identifier'),
    ...
    @pytest.mark.parametrize("field_name", [
        'servers', 'pools', 'origins', 'tags', 'domains',
        'items', 'rules', 'ips', 'hosts', 'headers'
    ])
    ...
    @pytest.mark.parametrize("field_name", [
        'port', 'vlan_id', 'timeout', 'interval', 'retries',
        'delay', 'weight', 'priority', 'threshold', 'limit'
    ])
...
if __name__ == '__main__':
    pytest.main([__file__, '-v', '--cov=scripts.utils.constraint_enricher', '--cov-report=term-missing'])
